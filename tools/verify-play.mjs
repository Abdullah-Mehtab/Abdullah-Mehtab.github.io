...
function assertGate4EBTRoutePlaceIntegrationVerification(result, failures) {
  assertGate4EBSBrunoRouteApproachBenchmarkEvidenceVerification(result, failures, 'gate-4e-bt-route-place-integration-pass');
