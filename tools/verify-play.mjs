...
function assertGate4EANCvRecordsVaultRouteArchiveVerification(result, failures) {
  assertGate4EAMSkillsLearningStackRouteAtriumVerification(result, failures, 'gate-4e-an-cv-records-vault-route-archive-pass');
