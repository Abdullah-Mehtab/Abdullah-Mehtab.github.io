...
function assertGate4EAIProjectsFoundryRouteBuildHallVerification(result, failures) {
  assertGate4EAHPotatoGreenhouseFrontageVerification(result, failures, 'gate-4e-ai-projects-foundry-route-build-hall-pass');
