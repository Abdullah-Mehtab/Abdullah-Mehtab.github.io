...
def create_projects_foundry_building(mats):
    ...
    cube("ProjectsFoundry_ServiceYard", group, (0, 0.09, -0.28), (15.4, 0.18, 8.6), mats["stone_shadow"], bevel=0.055)
    cube("ProjectsFoundry_MainHall", group, (-0.85, 2.28, 0.34), (12.4, 4.22, 6.2), mats["wood"], bevel=0.052)
    cube("ProjectsFoundry_UpperAssemblyHall", group, (-0.85, 4.68, 0.3), (10.8, 1.38, 5.0), mats["wood"], bevel=0.044)
    cube("ProjectsFoundry_FabricationBay", group, (5.58, 1.08, 0.18), (2.0, 1.68, 3.2), mats["wood"], bevel=0.034)
    cube("ProjectsFoundry_FabricationStack", group, (5.82, 2.2, 0.36), (0.78, 1.22, 1.5), mats["stone_shadow"], bevel=0.014)
    cube("ProjectsFoundry_SideWorkshop", group, (-6.22, 1.0, 0.74), (1.55, 1.48, 2.9), mats["stone"], bevel=0.034)
    cube("ProjectsFoundry_MaterialArchiveWing", group, (-6.38, 1.94, 0.74), (0.82, 1.18, 1.9), mats["stone"], bevel=0.014)
    cube("ProjectsFoundry_RoofMonitor", group, (-0.85, 4.52, 0.16), (12.2, 0.34, 5.85), mats["dark"], bevel=0.036)
    cube("ProjectsFoundry_RoofLantern", group, (0.2, 4.98, -0.55), (5.4, 0.58, 0.92), mats["glass"], bevel=0.024)
    cube("ProjectsFoundry_SawtoothRoofLine", group, (-0.85, 5.42, -0.56), (9.2, 0.2, 3.45), mats["stone_shadow"], bevel=0.022)
    ...
    cube("ProjectsFoundry_FurnaceChimney", group, (2.75, 5.44, 1.74), (0.86, 3.6, 0.86), mats["dark"], bevel=0.026)
    cube("ProjectsFoundry_FurnaceChimneyCap", group, (2.75, 7.38, 1.74), (1.22, 0.24, 1.22), mats["amber"], bevel=0.02)
    cube("ProjectsFoundry_HotMetalVent", group, (2.75, 6.42, 0.9), (0.82, 0.08, 0.06), mats["screen"], bevel=0.003)
    cube("ProjectsFoundry_SecondChimney", group, (4.4, 4.82, 2.22), (0.48, 2.72, 0.48), mats["dark"], bevel=0.018)
    cube("ProjectsFoundry_SecondChimneyCap", group, (4.4, 6.24, 2.22), (0.72, 0.18, 0.72), mats["mint"], bevel=0.012)
    cube("ProjectsFoundry_RoofCraneBridge", group, (0.4, 5.62, 2.72), (8.2, 0.12, 0.16), mats["amber"], bevel=0.006)
    ...
    cube("ProjectsFoundry_PublicBuildTheater", group, (-1.05, 2.06, 4.0), (7.0, 1.34, 0.1), mats["wood"], bevel=0.012)
    cube("ProjectsFoundry_PublicBuildGlass", group, (-1.05, 2.02, 4.08), (5.2, 0.78, 0.05), mats["glass"], bevel=0.006)
    cube("ProjectsFoundry_PublicBuildHeader", group, (-1.05, 3.0, 4.14), (7.35, 0.14, 0.08), mats["screen"], bevel=0.004)
    cube("ProjectsFoundry_PublicBuildFooter", group, (-1.05, 1.08, 4.14), (5.8, 0.12, 0.08), mats["amber"], bevel=0.004)
    cube("ProjectsFoundry_RouteAssemblyHallLeftPier", group, (-5.1, 2.08, 4.38), (0.22, 2.05, 0.1), mats["stone_shadow"], bevel=0.014)
    cube("ProjectsFoundry_RouteAssemblyHallRightPier", group, (3.0, 2.08, 4.38), (0.22, 2.05, 0.1), mats["stone_shadow"], bevel=0.014)
    cube("ProjectsFoundry_RouteAssemblyHallSill", group, (-1.05, 1.08, 4.38), (8.28, 0.14, 0.1), mats["stone_shadow"], bevel=0.01)
    cube("ProjectsFoundry_RouteAssemblyHallGlass", group, (-1.05, 2.08, 4.46), (6.3, 1.08, 0.05), mats["glass"], bevel=0.006)
    for index, x in enumerate([-4.0, -2.4, -0.8, 0.8, 2.4]):
        cube(f"ProjectsFoundry_RouteAssemblyHallMullion_{index}", group, (x, 2.08, 4.54), (0.07, 1.02, 0.05), mats["paper"], bevel=0.002)
    cube("ProjectsFoundry_RouteAssemblyHallHeader", group, (-1.05, 3.0, 4.54), (8.4, 0.14, 0.09), mats["wood"], bevel=0.008)
    cube("ProjectsFoundry_RouteAssemblyHallForgeCore", group, (-1.05, 1.28, 4.56), (5.0, 0.16, 0.06), mats["amber"], bevel=0.004)
    cube("ProjectsFoundry_RouteAssemblyHallCompileGlow", group, (-1.05, 2.72, 4.58), (4.8, 0.05, 0.05), mats["mint"], bevel=0.002)
    cube("ProjectsFoundry_RouteCranePortalLeft", group, (-5.28, 2.06, 4.52), (0.12, 2.35, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteCranePortalRight", group, (3.18, 2.06, 4.52), (0.12, 2.35, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteCranePortalBeam", group, (-1.05, 3.28, 4.52), (8.52, 0.12, 0.12), mats["stone_shadow"])
    ...
    cube("ProjectsFoundry_CompilePipelineBridge", group, (1.15, 3.76, 4.12), (4.4, 0.1, 0.14), mats["amber"], bevel=0.006)
    cube("ProjectsFoundry_CompilePipelineGlow", group, (1.15, 3.64, 4.26), (3.7, 0.04, 0.04), mats["mint"], bevel=0.002)
    for index, x in enumerate([-1.8, 0.0, 1.8]):
        cube(f"ProjectsFoundry_CompilePipelineNode_{index}", group, (x, 4.28, 4.38), (0.34, 0.3, 0.08), [mats["screen"], mats["mint"], mats["amber"]][index], bevel=0.008)
    for side, x in [("Left", -5.92), ("Right", 3.84)]:
        cube(f"ProjectsFoundry_RepoBranchFrame_{side}_PostA", group, (x, 1.72, 4.38), (0.14, 2.36, 0.14), mats["stone_shadow"])
        cube(f"ProjectsFoundry_RepoBranchFrame_{side}_PostB", group, (x + 0.78, 1.72, 4.38), (0.14, 2.36, 0.14), mats["stone_shadow"])
    ...
    cube("ProjectsFoundry_RouteBuildCraneBeam", group, (3.3, 3.06, 4.02), (1.82, 0.08, 0.1), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildCranePost", group, (4.08, 1.9, 4.02), (0.1, 1.92, 0.1), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalDeck", group, (-1.05, 0.74, 4.88), (7.6, 0.1, 0.18), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalLeftPier", group, (-4.78, 2.14, 4.92), (0.16, 2.18, 0.1), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalRightPier", group, (2.68, 2.14, 4.92), (0.16, 2.18, 0.1), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalHeader", group, (-1.05, 3.22, 4.92), (7.72, 0.14, 0.1), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalGlass", group, (-1.05, 2.14, 4.98), (5.75, 1.06, 0.05), mats["glass"])
    cube("ProjectsFoundry_RouteReleasePipelineSpine", group, (-0.62, 2.82, 5.06), (4.8, 0.08, 0.05), mats["mint"])
    ...
    cube("ProjectsFoundry_RouteCompileGantryFrame", group, (-1.05, 3.7, 5.12), (7.6, 0.12, 0.09), mats["stone_shadow"])
    cube("ProjectsFoundry_RoutePublicShowcaseAtriumFrame", group, (-1.05, 2.24, 5.34), (7.25, 1.62, 0.1), mats["stone_shadow"])
    cube("ProjectsFoundry_RoutePublicShowcaseAtriumGlass", group, (-1.05, 2.22, 5.42), (5.75, 0.98, 0.05), mats["glass"], bevel=0.005)
    cube("ProjectsFoundry_RoutePublicShowcaseAtriumHeader", group, (-1.05, 3.18, 5.48), (7.45, 0.16, 0.1), mats["wood"], bevel=0.008)
    cube("ProjectsFoundry_RouteReleaseTheaterScreen", group, (-4.28, 2.24, 5.56), (1.46, 1.0, 0.06), mats["screen"], bevel=0.004)
    cube("ProjectsFoundry_RouteReleaseTheaterStage", group, (-4.28, 1.02, 5.56), (1.72, 0.18, 0.3), mats["stone_shadow"], bevel=0.008)
    ...
    cube("ProjectsFoundry_RouteCompilePipelineStageRail", group, (3.08, 2.44, 5.6), (2.7, 0.08, 0.06), mats["mint"], bevel=0.003)
    for index, (x, y, material) in enumerate([(2.18, 1.66, mats["screen"]), (3.08, 2.22, mats["amber"]), (3.98, 2.78, mats["mint"])]):
        cube(f"ProjectsFoundry_RouteCompilePipelineStage_{index}", group, (x, y, 5.66), (0.44, 0.32, 0.06), material, bevel=0.003)
    cube("ProjectsFoundry_RouteBuildReviewBalcony", group, (2.36, 2.92, 5.54), (2.5, 0.12, 0.14), mats["paper"], bevel=0.006)
    cube("ProjectsFoundry_RouteBuildReviewCanopy", group, (2.36, 3.18, 5.48), (2.8, 0.1, 0.16), mats["dark"], bevel=0.006)
    cube("ProjectsFoundry_RouteReleaseGantryLeftFrame", group, (-4.82, 2.16, 5.76), (0.14, 2.35, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseGantryRightFrame", group, (2.72, 2.16, 5.76), (0.14, 2.35, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseGantryHeader", group, (-1.05, 3.42, 5.74), (7.7, 0.14, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseGantryStatusGlow", group, (-1.05, 3.72, 5.92), (5.7, 0.05, 0.05), mats["mint"], bevel=0.002)
    ...
    cube("ProjectsFoundry_RouteDeployBeaconStackCore", group, (5.72, 3.92, 4.98), (0.6, 2.75, 0.6), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteDeployBeaconStackCap", group, (5.72, 5.48, 4.98), (1.02, 0.3, 1.02), mats["mint"])
    cube("ProjectsFoundry_RouteRepositoryAtriumFaceFrame", group, (-1.05, 2.48, 6.18), (6.8, 2.0, 0.1), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteRepositoryAtriumFaceGlass", group, (-1.05, 2.42, 6.26), (5.35, 1.14, 0.05), mats["glass"], bevel=0.005)
    cube("ProjectsFoundry_RouteRepositoryAtriumFaceHeader", group, (-1.05, 3.6, 6.32), (7.0, 0.16, 0.1), mats["wood"], bevel=0.008)
    cube("ProjectsFoundry_RouteRepositoryAtriumFaceSill", group, (-1.05, 1.24, 6.32), (6.2, 0.14, 0.1), mats["stone_shadow"], bevel=0.008)
    for index, x in enumerate([-3.4, -1.05, 1.3]):
        cube(f"ProjectsFoundry_RouteRepositoryCommitColumn_{index}", group, (x, 2.6, 6.4), (0.09, 1.78, 0.06), mats["paper"], bevel=0.003)
        cube(f"ProjectsFoundry_RouteRepositoryCommitNode_{index}", group, (x, 1.8 + index * 0.38, 6.46), (0.28, 0.14, 0.05), [mats["screen"], mats["mint"], mats["amber"]][index], bevel=0.004)
    for index, (x, y) in enumerate([(-3.0, 2.02), (1.15, 2.68)]):
        cube(f"ProjectsFoundry_RouteRepositoryBranchTrace_{index}", group, (x, y, 6.5), (0.78, 0.06, 0.05), mats["mint" if index % 2 else "amber"], rot=(0, 0, 0.2 if index % 2 else -0.18), bevel=0.002)
    cube("ProjectsFoundry_RouteBuildPipelineRunwayDeck", group, (-1.05, 0.46, 6.74), (8.4, 0.14, 0.72), mats["stone_shadow"], bevel=0.014)
    cube("ProjectsFoundry_RouteBuildPipelineRunwayCenterGlow", group, (-1.05, 0.58, 7.1), (6.2, 0.05, 0.05), mats["mint"], bevel=0.003)
    for index, x in enumerate([-4.65, -2.25, 0.15, 2.55]):
        cube(f"ProjectsFoundry_RouteBuildPipelineRunwayStage_{index}", group, (x, 0.62, 6.74), (0.46, 0.08, 0.46), [mats["screen"], mats["amber"], mats["mint"], mats["paper"]][index % 4], bevel=0.006)
    ...
    cube("ProjectsFoundry_RouteReleaseCraneCrownLeft", group, (-4.82, 4.18, 6.18), (0.14, 0.76, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseCraneCrownRight", group, (2.72, 4.18, 6.18), (0.14, 0.76, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseCraneCrownBeam", group, (-1.05, 4.6, 6.18), (7.75, 0.14, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseCraneCrownGlow", group, (-1.05, 4.82, 6.36), (5.8, 0.05, 0.05), mats["amber"], bevel=0.002)
    cube("ProjectsFoundry_RoutePublicBuildForecourt", group, (-1.05, 0.34, 7.32), (11.2, 0.14, 0.68), mats["stone_shadow"])
    multi_cube("ProjectsFoundry_RouteVehicleScaleBuildArch", group, [
        ((-6.2, 2.82, 7.38), (0.36, 4.65, 0.28), (0, 0, 0)),
        ((4.1, 2.82, 7.38), (0.36, 4.65, 0.28), (0, 0, 0)),
        ((-1.05, 5.08, 7.38), (10.7, 0.36, 0.3), (0, 0, 0)),
    ], mats["dark"])
    cube("ProjectsFoundry_RouteOpenWorkshopDoor", group, (-1.05, 2.46, 7.56), (9.0, 2.72, 0.1), mats["dark"])
    cube("ProjectsFoundry_RouteOpenWorkshopGlow", group, (-1.05, 2.46, 7.64), (6.4, 1.42, 0.05), mats["glass"])
    cube("ProjectsFoundry_RouteBuildFlowThreshold", group, (-1.05, 0.7, 7.72), (8.6, 0.1, 0.1), mats["amber"])
    for index, x in enumerate([-3.95, -1.05, 1.85]):
        cube(f"ProjectsFoundry_RouteReleaseReviewBay_{index}", group, (x, 2.42, 7.78), (1.36, 0.86, 0.06), [mats["screen"], mats["mint"], mats["amber"]][index])
        cube(f"ProjectsFoundry_RouteReleaseReviewDock_{index}", group, (x, 1.24, 7.72), (1.42, 0.16, 0.28), mats["paper"])
    cube("ProjectsFoundry_RouteSideRepositoryFaceFrame", group, (7.06, 3.0, 1.08), (0.1, 2.42, 2.0), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteSideRepositoryFaceGlass", group, (7.14, 3.0, 1.08), (0.06, 1.9, 1.55), mats["glass"], bevel=0.006)
    ...
    cube("ProjectsFoundry_RouteFabricationStackPublicFace", group, (5.82, 3.62, -1.22), (1.34, 1.62, 0.06), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteFabricationStackReviewGlass", group, (5.82, 3.94, -1.28), (1.04, 1.22, 0.05), mats["glass"], bevel=0.005)
    cube("ProjectsFoundry_RouteFabricationStackReviewHeader", group, (5.82, 4.78, -1.32), (1.34, 0.14, 0.05), mats["screen"], bevel=0.003)
    cube("ProjectsFoundry_RouteFabricationStackDeployLine", group, (5.82, 3.08, -1.34), (1.12, 0.08, 0.05), mats["amber"], bevel=0.003)
    ...
    cube("ProjectsFoundry_RouteFabricationStackSideFace", group, (6.98, 3.86, 0.58), (0.08, 2.25, 2.12), mats["stone_shadow"])
...
def create_sentinel_soc_tower(mats):
    ...
    cube("SentinelSoc_RouteCommandFacade", group, (6.98, 3.18, -0.18), (0.12, 4.7, 5.6), mats["dark"])
    cube("SentinelSoc_RouteCommandGlass", group, (7.07, 3.1, -0.18), (0.08, 3.7, 4.68), mats["glass"])
    cube("SentinelSoc_RouteCommandHeader", group, (7.12, 5.42, -0.18), (0.08, 0.22, 5.08), mats["screen"])
    cube("SentinelSoc_RouteCommandDeck", group, (7.14, 1.04, -0.18), (0.08, 0.24, 5.18), mats["paper"])
    cube("SentinelSoc_RouteShieldCrestTop", group, (7.2, 3.66, -0.18), (0.06, 0.14, 1.85), mats["mint"])
    cube("SentinelSoc_RouteShieldCrestLeft", group, (7.22, 2.92, -0.88), (0.06, 1.42, 0.14), mats["mint"], rot=(0.28, 0, 0))
    cube("SentinelSoc_RouteShieldCrestRight", group, (7.22, 2.92, 0.52), (0.06, 1.42, 0.14), mats["mint"], rot=(-0.28, 0, 0))
    cube("SentinelSoc_RouteShieldCore", group, (7.24, 2.86, -0.18), (0.06, 0.74, 0.78), mats["screen"])
    cube("SentinelSoc_RouteThreatBoard", group, (7.22, 3.04, 1.64), (0.06, 2.1, 1.42), mats["pink"])
    for index, y in enumerate([2.18, 2.62, 3.06, 3.5, 3.94]):
        cube(f"SentinelSoc_RouteThreatTrace_{index}", group, (7.28, y, 1.64), (0.04, 0.07, 1.0 - index * 0.08), [mats["screen"], mats["mint"], mats["aqua"], mats["screen"], mats["mint"]][index])
    for index, z in enumerate([-2.1, -1.34, -0.58, 0.18, 0.94]):
        cube(f"SentinelSoc_RouteStatusLane_{index}", group, (7.26, 1.68 + index * 0.34, z), (0.05, 0.08, 0.58), [mats["screen"], mats["mint"], mats["pink"], mats["aqua"], mats["screen"]][index])
    cube("SentinelSoc_RouteOpsPortalLeftPylon", group, (7.34, 3.05, -3.08), (0.46, 5.72, 0.54), mats["dark"], bevel=0.024)
    cube("SentinelSoc_RouteOpsPortalRightPylon", group, (7.34, 3.05, 2.72), (0.46, 5.72, 0.54), mats["dark"], bevel=0.024)
    cube("SentinelSoc_RouteOpsPortalOverhead", group, (7.34, 5.82, -0.18), (0.5, 0.54, 6.28), mats["dark"], bevel=0.022)
    cube("SentinelSoc_RouteOpsPortalThreshold", group, (7.42, 0.58, -0.18), (0.18, 0.32, 5.62), mats["paper"], bevel=0.014)
    cube("SentinelSoc_RouteWarRoomVolume", group, (6.28, 2.74, -0.18), (1.72, 3.44, 4.32), mats["glass"], bevel=0.018)
    cube("SentinelSoc_RouteWarRoomFloor", group, (6.3, 1.02, -0.18), (1.78, 0.22, 4.16), mats["security"] if "security" in mats else mats["stone_shadow"], bevel=0.014)
    cube("SentinelSoc_RouteWarRoomCommandDesk", group, (6.92, 1.42, -0.18), (0.42, 0.56, 2.8), mats["dark"], bevel=0.014)
    for index, z in enumerate([-1.54, -0.72, 0.1, 0.92, 1.74]):
        cube(f"SentinelSoc_RoutePacketQueueRail_{index}", group, (7.47, 1.12 + index * 0.16, z), (0.06, 0.08, 0.58), [mats["mint"], mats["screen"], mats["aqua"], mats["pink"], mats["mint"]][index], bevel=0.003)
    cube("SentinelSoc_RouteDefenseCanopy", group, (6.74, 4.78, -0.18), (1.52, 0.24, 5.44), mats["screen"], bevel=0.01)
    cube("SentinelSoc_RouteDefenseCanopyGlow", group, (7.52, 4.94, -0.18), (0.06, 0.07, 4.8), mats["mint"], bevel=0.003)
    cube("SentinelSoc_RouteEntryPorticoDeck", group, (8.32, 0.62, -0.18), (2.25, 0.36, 5.62), mats["security"] if "security" in mats else mats["stone_shadow"], bevel=0.022)
    cube("SentinelSoc_RouteEntryPorticoLeftTower", group, (8.62, 2.78, -2.96), (1.02, 4.55, 0.92), mats["stone_shadow"], bevel=0.028)
    cube("SentinelSoc_RouteEntryPorticoRightTower", group, (8.62, 2.78, 2.6), (1.02, 4.55, 0.92), mats["stone_shadow"], bevel=0.028)
    cube("SentinelSoc_RouteEntryPorticoRoof", group, (8.46, 5.12, -0.18), (2.1, 0.44, 5.88), mats["dark"], bevel=0.02)
    cube("SentinelSoc_RouteEntryPorticoScanBar", group, (9.48, 3.38, -0.18), (0.1, 0.16, 4.82), mats["mint"], bevel=0.004)
    cube("SentinelSoc_RouteEntryPorticoShieldLeft", group, (9.38, 2.24, -1.28), (0.12, 2.52, 0.2), mats["screen"], rot=(0.0, 0.0, -0.28), bevel=0.006)
    cube("SentinelSoc_RouteEntryPorticoShieldRight", group, (9.38, 2.24, 0.92), (0.12, 2.52, 0.2), mats["screen"], rot=(0.0, 0.0, 0.28), bevel=0.006)
    ...
    cube("SentinelSoc_RouteShieldThresholdScan", group, (10.12, 4.08, -0.18), (0.08, 0.14, 5.72), mats["mint"], bevel=0.004)
    cube("SentinelSoc_RouteShieldThresholdCrestTop", group, (10.16, 3.42, -0.18), (0.07, 0.18, 2.15), mats["mint"], bevel=0.004)
    cube("SentinelSoc_RouteShieldThresholdCrestLeft", group, (10.18, 2.56, -0.92), (0.07, 1.72, 0.16), mats["screen"], rot=(0.24, 0, 0), bevel=0.004)
    cube("SentinelSoc_RouteShieldThresholdCrestRight", group, (10.18, 2.56, 0.56), (0.07, 1.72, 0.16), mats["screen"], rot=(-0.24, 0, 0), bevel=0.004)
    cube("SentinelSoc_RouteSocFrontageLeftWing", group, (8.96, 2.54, -4.24), (2.5, 3.55, 0.55), mats["stone_shadow"], bevel=0.032)
    cube("SentinelSoc_RouteSocFrontageRightWing", group, (8.96, 2.54, 3.88), (2.5, 3.55, 0.55), mats["stone_shadow"], bevel=0.032)
    cube("SentinelSoc_RouteSocFrontageLeftGlass", group, (9.64, 2.62, -4.52), (1.4, 2.26, 0.07), mats["glass"], bevel=0.006)
    cube("SentinelSoc_RouteSocFrontageRightGlass", group, (9.64, 2.62, 4.16), (1.4, 2.26, 0.07), mats["glass"], bevel=0.006)
    for index, z in enumerate([-2.2, -1.1, 0.0, 1.1, 2.2]):
        cube(f"SentinelSoc_RouteInspectionLaneMark_{index}", group, (9.72, 0.26, z), (1.28, 0.07, 0.14), [mats["mint"], mats["screen"], mats["aqua"], mats["screen"], mats["mint"]][index], bevel=0.003)
    cube("SentinelSoc_RouteThreatIntelCrownMast", group, (3.85, 8.52, -0.18), (0.28, 4.1, 0.28), mats["dark"], bevel=0.01)
    cube("SentinelSoc_RouteThreatIntelCrownBar", group, (3.85, 10.22, -0.18), (4.8, 0.18, 0.2), mats["pink"], bevel=0.006)
    cube("SentinelSoc_RouteThreatIntelCrownUpperBar", group, (3.85, 11.26, -0.18), (3.5, 0.13, 0.16), mats["screen"], bevel=0.004)
    cube("SentinelSoc_RouteCommandBeaconMast", group, (5.76, 7.72, 2.62), (0.22, 3.7, 0.22), mats["dark"], bevel=0.008)
    cube("SentinelSoc_RouteCommandBeaconHead", group, (5.76, 9.72, 2.62), (0.72, 0.46, 0.72), mats["mint"], bevel=0.018)
...
def create_signal_harbor_communications_station(mats):
    ...
    cube("SignalHarbor_RoutePublicSignalGatewayDeck", group, (0.12, 0.62, 5.58), (13.8, 0.26, 0.88), mats["paper"], bevel=0.022)
    cube("SignalHarbor_RouteContactForecourt", group, (0.12, 0.34, 6.52), (12.6, 0.16, 1.82), mats["stone"], bevel=0.035)
    cube("SignalHarbor_RouteContactArrivalConcourse", group, (0.12, 0.22, 8.48), (9.6, 0.12, 3.78), mats["paper"], bevel=0.04)
    cube("SignalHarbor_RouteConcourseCenterSpine", group, (0.12, 0.36, 8.48), (0.42, 0.08, 3.42), mats["stone_shadow"], bevel=0.012)
    for index, x in enumerate([-4.64, 4.88]):
        cube(f"SignalHarbor_RouteConcourseEdge_{index}", group, (x, 0.48, 8.48), (0.24, 0.26, 3.72), mats["stone_shadow"], bevel=0.018)
        cube(f"SignalHarbor_RouteConcourseEdgeGlow_{index}", group, (x, 0.72, 8.48), (0.1, 0.08, 3.04), [mats["mint"], mats["screen"]][index], bevel=0.003)
    for index, z in enumerate([7.18, 8.02, 8.86, 9.7]):
        cube(f"SignalHarbor_RouteContactQueueStep_{index}", group, (0.12, 0.43, z), (6.9 - index * 0.52, 0.07, 0.12), [mats["stone_shadow"], mats["mint"], mats["screen"], mats["stone_shadow"]][index], bevel=0.004)
    cube("SignalHarbor_RoutePublicSignalArrivalThreshold", group, (0.12, 0.58, 9.56), (8.4, 0.22, 0.52), mats["stone_shadow"])
    multi_cube("SignalHarbor_RouteVehicleMessagePortal", group, [
        ((-4.42, 2.86, 9.62), (0.36, 4.96, 0.32), (0, 0, 0)),
        ((4.66, 2.86, 9.62), (0.36, 4.96, 0.32), (0, 0, 0)),
        ((0.12, 5.42, 9.62), (9.58, 0.34, 0.38), (0, 0, 0)),
    ], mats["dark"])
    cube("SignalHarbor_RouteContactSignalWindow", group, (0.12, 3.02, 9.78), (6.9, 2.26, 0.08), mats["glass"])
    cube("SignalHarbor_RouteContactSignalHeader", group, (0.12, 4.28, 9.84), (6.2, 0.12, 0.06), mats["mint"])
    cube("SignalHarbor_RouteContactSignalFooter", group, (0.12, 1.68, 9.84), (5.5, 0.08, 0.06), mats["screen"])
    for index, x in enumerate([-2.62, 0.12, 2.86]):
        cube(f"SignalHarbor_RouteMessageArrivalBay_{index}", group, (x, 1.88, 9.92), (1.28, 1.34, 0.08), [mats["screen"], mats["mint"], mats["aqua"]][index])
    cube("SignalHarbor_RouteExchangeCanopy", group, (0.12, 3.92, 6.24), (11.4, 0.22, 1.18), mats["dark"], bevel=0.02)
    cube("SignalHarbor_RouteContactEnvelopeArch", group, (0.12, 4.42, 6.72), (9.8, 0.18, 0.16), mats["paper"], bevel=0.008)
    cube("SignalHarbor_RouteContactEnvelopeFlapLeft", group, (-2.28, 3.42, 6.82), (4.38, 0.12, 0.1), mats["paper"], rot=(0.0, 0.0, -0.34), bevel=0.004)
    cube("SignalHarbor_RouteContactEnvelopeFlapRight", group, (2.52, 3.42, 6.82), (4.38, 0.12, 0.1), mats["paper"], rot=(0.0, 0.0, 0.34), bevel=0.004)
    for index, x in enumerate([-3.6, 0.12, 3.84]):
        cube(f"SignalHarbor_RouteExchangeDesk_{index}", group, (x, 1.02, 6.26), (1.92, 0.72, 0.74), mats["stone_shadow"], bevel=0.025)
        cube(f"SignalHarbor_RouteExchangeDeskGlow_{index}", group, (x, 1.42, 6.66), (1.42, 0.08, 0.08), [mats["screen"], mats["mint"], mats["aqua"]][index], bevel=0.004)
    for index, x in enumerate([-4.9, -2.45, 0.0, 2.45, 4.9]):
        cube(f"SignalHarbor_RouteMessageLane_{index}", group, (x, 0.47, 6.96), (0.28, 0.05, 1.28), [mats["paper"], mats["screen"], mats["mint"], mats["aqua"], mats["paper"]][index], bevel=0.002)
    for index, x in enumerate([-5.35, 0.12, 5.59]):
        cube(f"SignalHarbor_RouteSignalQueuePylon_{index}", group, (x, 2.22, 6.94), (0.28, 3.24, 0.28), mats["dark"], bevel=0.014)
        cube(f"SignalHarbor_RouteSignalQueueBeacon_{index}", group, (x, 3.96, 6.94), (0.68, 0.34, 0.68), [mats["screen"], mats["mint"], mats["aqua"]][index], bevel=0.02)
    for x in [-6.48, 6.72]:
        cube("SignalHarbor_RoutePublicSignalGatewayPylon", group, (x, 3.58, 5.42), (0.48, 5.75, 0.54), mats["dark"], bevel=0.024)
        cube("SignalHarbor_RoutePublicSignalGatewayTrace", group, (x, 3.58, 5.76), (0.08, 4.7, 0.08), mats["screen"], bevel=0.003)
    cube("SignalHarbor_RoutePublicSignalGatewayBeam", group, (0.12, 6.42, 5.42), (13.72, 0.32, 0.54), mats["dark"], bevel=0.02)
    cube("SignalHarbor_RoutePublicSignalGatewayPulse", group, (0.12, 6.12, 5.82), (11.6, 0.1, 0.08), mats["mint"], bevel=0.003)
    cube("SignalHarbor_RouteMessageBridgeSpan", group, (0.12, 5.32, 5.64), (9.9, 0.18, 0.26), mats["screen"], bevel=0.006)
    for index, x in enumerate([-4.78, 5.02]):
        cube(f"SignalHarbor_RouteInboxOutboxTower_{index}", group, (x, 3.48, 5.92), (1.52, 5.28, 0.5), mats["stone_shadow"], bevel=0.026)
        cube(f"SignalHarbor_RouteInboxOutboxTowerGlass_{index}", group, (x, 3.38, 6.24), (1.04, 3.72, 0.08), [mats["screen"], mats["mint"]][index], bevel=0.006)
        for row, y in enumerate([1.85, 2.44, 3.03, 3.62, 4.21, 4.8]):
            cube(f"SignalHarbor_RouteInboxOutboxTowerSlot_{index}_{row}", group, (x, y, 6.32), (0.76 - (row % 2) * 0.14, 0.07, 0.06), [mats["paper"], mats["screen"], mats["aqua"], mats["mint"], mats["amber"], mats["screen"]][row], bevel=0.003)
    cube("SignalHarbor_RouteContactBeaconSpine", group, (0.12, 7.22, 5.72), (0.32, 4.22, 0.32), mats["dark"], bevel=0.012)
    cube("SignalHarbor_RouteContactBeaconCore", group, (0.12, 9.42, 5.72), (1.08, 0.72, 1.08), mats["screen"], bevel=0.028)
    cube("SignalHarbor_RouteSignalCrownArrayBase", group, (0.12, 10.02, 5.72), (4.4, 0.18, 0.42), mats["dark"], bevel=0.012)
    for index, angle in enumerate([-0.62, -0.31, 0.0, 0.31, 0.62]):
        cube(f"SignalHarbor_RouteSignalCrownArrayArm_{index}", group, (0.12, 10.28, 5.72), (4.2 - abs(index - 2) * 0.34, 0.08, 0.08), [mats["mint"], mats["screen"], mats["aqua"], mats["screen"], mats["mint"]][index], rot=(0.0, angle, 0.0), bevel=0.004)
    cone("SignalHarbor_RouteSignalCrownDish", group, (-1.9, 8.45, 5.28), 1.12, 0.32, mats["foam"], vertices=22, rot=(math.pi / 2, 0.0, 0.42))
