...
def create_projects_foundry_building(mats):
    ...
    cube("ProjectsFoundry_RouteCranePortalLeft", group, (-6.92, 2.72, 4.52), (0.32, 4.92, 0.3), mats["dark"], bevel=0.018)
    cube("ProjectsFoundry_RouteCranePortalRight", group, (4.82, 2.72, 4.52), (0.32, 4.92, 0.3), mats["dark"], bevel=0.018)
    cube("ProjectsFoundry_RouteCranePortalBeam", group, (-1.05, 5.24, 4.52), (12.08, 0.32, 0.34), mats["dark"], bevel=0.02)
    cube("ProjectsFoundry_RouteCranePortalTrolley", group, (1.65, 4.82, 4.66), (0.82, 0.34, 0.32), mats["stone_shadow"], bevel=0.016)
    cube("ProjectsFoundry_RouteCranePortalHook", group, (1.65, 3.86, 4.72), (0.16, 1.48, 0.12), mats["rope"], bevel=0.004)
    cube("ProjectsFoundry_RouteCranePortalLoad", group, (1.65, 2.98, 4.78), (1.1, 0.52, 0.46), mats["stone"], bevel=0.018)
