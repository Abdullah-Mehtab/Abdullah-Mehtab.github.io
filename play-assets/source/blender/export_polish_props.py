...
def create_behind_engineering_garage_workshop_hall(mats):
    ...
    cube("BehindEngineeringGarage_WorkApron", group, (0, 0.12, -5.15), (18.2, 0.24, 5.6), mats["stone_shadow"], bevel=0.075)
    cube("BehindEngineeringGarage_RoadThreshold", group, (0, 0.28, -7.7), (12.6, 0.18, 0.9), mats["paper"], bevel=0.035)
    cube("BehindEngineeringGarage_MainWorkshopHall", group, (-0.55, 3.18, 0.02), (14.6, 6.1, 7.35), mats["stone_shadow"], bevel=0.075)
    cube("BehindEngineeringGarage_ToolArchiveWing", group, (-8.65, 2.42, 0.08), (3.65, 4.55, 6.65), mats["wood"], bevel=0.06)
    cube("BehindEngineeringGarage_ServiceWing", group, (7.15, 2.55, 0.08), (4.35, 4.82, 6.65), mats["stone"], bevel=0.06)
    cube("BehindEngineeringGarage_MainRoof", group, (-0.55, 6.45, 0.02), (15.75, 0.42, 8.05), mats["wood"], bevel=0.04)
    cube("BehindEngineeringGarage_ToolWingRoof", group, (-8.65, 4.95, 0.08), (4.08, 0.3, 7.05), mats["wood"], bevel=0.032)
    cube("BehindEngineeringGarage_ServiceWingRoof", group, (7.15, 5.12, 0.08), (4.78, 0.3, 7.05), mats["wood"], bevel=0.032)
    cube("BehindEngineeringGarage_FrontRoofFascia", group, (-0.55, 6.55, -4.1), (16.2, 0.34, 0.32), mats["dark"], bevel=0.016)
    cube("BehindEngineeringGarage_RearRoofFascia", group, (-0.55, 6.55, 4.1), (16.2, 0.34, 0.32), mats["dark"], bevel=0.016)
    cube("BehindEngineeringGarage_LeftRoofFascia", group, (-8.75, 6.55, 0.02), (0.32, 0.34, 7.86), mats["dark"], bevel=0.014)
    cube("BehindEngineeringGarage_RightRoofFascia", group, (7.65, 6.55, 0.02), (0.32, 0.34, 7.86), mats["dark"], bevel=0.014)

    cube("BehindEngineeringGarage_RoofClerestory", group, (-0.55, 7.0, -0.62), (9.8, 0.82, 2.1), mats["stone"], bevel=0.028)
    cube("BehindEngineeringGarage_RoofClerestoryFrontGlass", group, (-0.55, 7.0, -1.72), (8.8, 0.42, 0.08), mats["glass"], bevel=0.006)
    cube("BehindEngineeringGarage_RoofClerestoryRearGlass", group, (-0.55, 7.0, 0.48), (8.8, 0.34, 0.08), mats["glass"], bevel=0.006)
    cube("BehindEngineeringGarage_RoofClerestoryCap", group, (-0.55, 7.48, -0.62), (10.25, 0.18, 2.42), mats["dark"], bevel=0.012)

    cube("BehindEngineeringGarage_RollupBayFrame", group, (-1.05, 2.72, -3.98), (9.8, 4.45, 0.36), mats["dark"], bevel=0.04)
    cube("BehindEngineeringGarage_RollupDoor", group, (-1.05, 2.34, -4.24), (7.72, 3.22, 0.14), mats["stone"], bevel=0.022)
    for index, y in enumerate([0.92, 1.32, 1.72, 2.12, 2.52, 2.92, 3.32]):
        cube(f"BehindEngineeringGarage_RollupDoorRib_{index}", group, (-1.05, y, -4.36), (7.52, 0.055, 0.07), mats["paper"], bevel=0.003)
    cube("BehindEngineeringGarage_BayCanopy", group, (-1.05, 5.02, -4.72), (10.55, 0.36, 0.92), mats["dark"], bevel=0.026)
    cube("BehindEngineeringGarage_BayStatusLight", group, (-1.05, 4.68, -5.2), (7.45, 0.08, 0.07), mats["screen"], bevel=0.004)
    cube("BehindEngineeringGarage_ServiceDoor", group, (5.72, 1.66, -4.2), (1.32, 2.62, 0.14), mats["wood"], bevel=0.018)
    cube("BehindEngineeringGarage_ServiceDoorCanopy", group, (5.72, 3.1, -4.36), (1.72, 0.18, 0.42), mats["dark"], bevel=0.012)

    cube("BehindEngineeringGarage_PrototypeLiftDeck", group, (-1.1, 0.78, -5.22), (5.9, 0.28, 0.78), mats["dark"], bevel=0.018)
    cube("BehindEngineeringGarage_PrototypeBodyBuck", group, (-1.1, 1.32, -5.38), (3.9, 0.62, 0.38), mats["amber"], bevel=0.022)
    cube("BehindEngineeringGarage_PrototypeCabinBuck", group, (-0.02, 1.76, -5.5), (1.08, 0.48, 0.18), mats["glass"], bevel=0.012)
    for index, x in enumerate([-2.78, 0.58]):
        cube(f"BehindEngineeringGarage_PrototypeWheelBuck_{index}", group, (x, 0.98, -5.52), (0.4, 0.46, 0.1), mats["rubber"], bevel=0.01)

    cube("BehindEngineeringGarage_DiagnosticsPanel", group, (6.22, 2.6, -4.28), (2.15, 2.9, 0.14), mats["dark"], bevel=0.02)
    for index, y in enumerate([1.44, 1.94, 2.44, 2.94]):
        cube(f"BehindEngineeringGarage_DiagnosticsLine_{index}", group, (6.22, y, -4.42), (1.48 - index * 0.1, 0.07, 0.06), [mats["screen"], mats["mint"], mats["aqua"], mats["paper"]][index], bevel=0.003)
    cube("BehindEngineeringGarage_SourceControlPanel", group, (-6.6, 2.6, -4.24), (1.02, 2.95, 0.14), mats["dark"], bevel=0.018)
    for index, y in enumerate([1.42, 1.9, 2.38, 2.86]):
        cube(f"BehindEngineeringGarage_SourceControlBranch_{index}", group, (-6.6, y, -4.38), (0.62 + index * 0.12, 0.07, 0.06), mats["mint"], bevel=0.003)

    cube("BehindEngineeringGarage_RearWall", group, (-0.55, 3.0, 4.02), (13.0, 4.8, 0.26), mats["stone_shadow"], bevel=0.032)
    cube("BehindEngineeringGarage_RearLoadingDockApron", group, (3.72, 0.36, 4.78), (3.95, 0.18, 1.28), mats["stone"], bevel=0.024)
    cube("BehindEngineeringGarage_RearLoadingDoorFrame", group, (3.72, 2.12, 4.27), (3.15, 3.42, 0.18), mats["dark"], bevel=0.018)
    cube("BehindEngineeringGarage_RearLoadingDoor", group, (3.72, 1.98, 4.4), (2.38, 2.72, 0.1), mats["wood"], bevel=0.014)
    for index, y in enumerate([1.02, 1.42, 1.82, 2.22, 2.62, 3.02]):
        cube(f"BehindEngineeringGarage_RearDoorRib_{index}", group, (3.72, y, 4.48), (2.18, 0.052, 0.055), mats["paper"], bevel=0.002)
    cube("BehindEngineeringGarage_RearInspectionWindowFrame", group, (-2.78, 3.12, 4.24), (5.3, 2.18, 0.16), mats["dark"], bevel=0.016)
    cube("BehindEngineeringGarage_RearInspectionWindow", group, (-2.78, 3.12, 4.36), (4.65, 1.58, 0.08), mats["glass"], bevel=0.008)
    for index, x in enumerate([-4.36, -3.28, -2.2, -1.12]):
        cube(f"BehindEngineeringGarage_RearWindowMullion_{index}", group, (x, 3.12, 4.44), (0.06, 1.58, 0.055), mats["screen" if index % 2 else "paper"], bevel=0.002)
    cube("BehindEngineeringGarage_RearHeader", group, (-0.55, 5.45, 4.24), (12.6, 0.26, 0.28), mats["dark"], bevel=0.012)
    for index, x in enumerate([-6.55, -4.95, 0.25, 5.9]):
        cube(f"BehindEngineeringGarage_RearStructuralPier_{index}", group, (x, 3.0, 4.32), (0.22, 4.42, 0.14), mats["wood"], bevel=0.008)

    for index, z in enumerate([-2.2, -0.75, 0.7, 2.15]):
        cube(f"BehindEngineeringGarage_ServiceWingWindow_{index}", group, (9.4, 2.7, z), (0.08, 0.74, 0.76), mats["glass"], bevel=0.006)
        cube(f"BehindEngineeringGarage_ServiceWingMullion_{index}", group, (9.46, 2.7, z), (0.05, 0.88, 0.08), mats["dark"], bevel=0.003)
        cube(f"BehindEngineeringGarage_ToolWingWindow_{index}", group, (-10.34, 2.48, z), (0.08, 0.64, 0.72), mats["glass"], bevel=0.006)
    for side, x, accent in [("Service", 9.5, mats["screen"]), ("Tool", -10.5, mats["paper"])]:
        cube(f"BehindEngineeringGarage_{side}SideTopLintel", group, (x, 4.54, -0.02), (0.12, 0.16, 5.78), mats["dark"], bevel=0.004)
        cube(f"BehindEngineeringGarage_{side}SideBaseTrim", group, (x, 0.82, -0.02), (0.12, 0.14, 5.78), mats["wood"], bevel=0.004)
        cube(f"BehindEngineeringGarage_{side}SideFrontPier", group, (x, 2.68, -3.03), (0.13, 3.48, 0.16), mats["dark"], bevel=0.004)
        cube(f"BehindEngineeringGarage_{side}SideMiddlePier", group, (x, 2.68, 0.02), (0.13, 3.48, 0.14), accent, bevel=0.003)
        cube(f"BehindEngineeringGarage_{side}SideRearPier", group, (x, 2.68, 3.03), (0.13, 3.48, 0.16), mats["dark"], bevel=0.004)
    cube("BehindEngineeringGarage_ServiceSidePersonnelDoor", group, (9.56, 1.46, -2.9), (0.08, 2.14, 0.92), mats["wood"], bevel=0.012)
    cube("BehindEngineeringGarage_ServiceSideDoorCanopy", group, (9.62, 2.72, -2.9), (0.12, 0.16, 1.32), mats["dark"], bevel=0.006)
    cube("BehindEngineeringGarage_ToolSideArchiveDoor", group, (-10.56, 1.42, 2.86), (0.08, 2.05, 0.92), mats["wood"], bevel=0.012)
    cube("BehindEngineeringGarage_ToolSideDoorCanopy", group, (-10.62, 2.65, 2.86), (0.12, 0.16, 1.28), mats["dark"], bevel=0.006)

    cube("BehindEngineeringGarage_ToolWall", group, (-10.45, 2.4, -2.85), (0.12, 2.55, 1.65), mats["dark"], bevel=0.014)
    for index, y in enumerate([1.52, 2.12, 2.72]):
        cube(f"BehindEngineeringGarage_ToolRail_{index}", group, (-10.54, y, -2.85), (0.06, 0.06, 1.35), mats["paper"], bevel=0.003)
    cube("BehindEngineeringGarage_RoofServiceBlock", group, (-0.75, 7.0, 2.36), (3.55, 0.62, 1.1), mats["stone"], bevel=0.03)
    cube("BehindEngineeringGarage_RoofServiceWindow", group, (-0.75, 7.1, 1.88), (3.85, 0.36, 0.08), mats["glass"], bevel=0.006)
    for index, x in enumerate([-5.2, 5.0]):
        cube(f"BehindEngineeringGarage_ExhaustStack_{index}", group, (x, 7.08, 2.42), (0.48, 0.86, 0.48), mats["stone"], bevel=0.018)
        cube(f"BehindEngineeringGarage_ExhaustCap_{index}", group, (x, 7.58, 2.42), (0.68, 0.1, 0.68), mats["dark"], bevel=0.01)
    cube("BehindEngineeringGarage_WorkshopStatusBeacon", group, (4.75, 7.38, -2.38), (0.58, 1.08, 0.58), mats["mint"], bevel=0.016)
...
def create_awards_museum_hall(mats):
    ...
    cube("AwardsMuseum_CivicPlinth", group, (0, 0.11, -0.18), (16.8, 0.22, 10.8), mats["stone"], bevel=0.075)
    cube("AwardsMuseum_RoadArrivalWalk", group, (0, 0.26, -6.05), (10.4, 0.14, 2.1), mats["paper"], bevel=0.035)
    cube("AwardsMuseum_CeremonialThreshold", group, (0, 0.36, -5.0), (8.4, 0.12, 0.7), mats["gold"], bevel=0.018)

    cube("AwardsMuseum_MainGalleryBlock", group, (0, 2.74, 0.15), (12.0, 5.05, 6.25), mats["stone_shadow"], bevel=0.07)
    cube("AwardsMuseum_FrontLimestoneFace", group, (0, 2.7, -3.18), (12.45, 4.92, 0.42), mats["stone"], bevel=0.045)
    cube("AwardsMuseum_RearArchiveFace", group, (0, 2.64, 3.48), (12.45, 4.78, 0.48), mats["stone_shadow"], bevel=0.045)
    cube("AwardsMuseum_LeftGalleryWing", group, (-6.35, 2.4, 0.2), (1.65, 4.45, 6.45), mats["stone"], bevel=0.055)
    cube("AwardsMuseum_RightGalleryWing", group, (6.35, 2.4, 0.2), (1.65, 4.45, 6.45), mats["stone"], bevel=0.055)
    cube("AwardsMuseum_CentralAtriumVolume", group, (0, 3.32, -2.96), (5.1, 5.65, 0.9), mats["glass"], bevel=0.025)
    cube("AwardsMuseum_EntryPortalFrame", group, (0, 2.45, -4.02), (5.95, 4.38, 0.46), mats["dark"], bevel=0.028)
    cube("AwardsMuseum_EntryPortalVoid", group, (0, 2.1, -4.28), (3.7, 3.0, 0.16), mats["glass"], bevel=0.012)
    cube("AwardsMuseum_DoubleDoorLeft", group, (-0.68, 1.18, -4.42), (1.18, 1.9, 0.08), mats["dark"], bevel=0.012)
    cube("AwardsMuseum_DoubleDoorRight", group, (0.68, 1.18, -4.42), (1.18, 1.9, 0.08), mats["dark"], bevel=0.012)
    cube("AwardsMuseum_DoorMedalGlow", group, (0, 2.28, -4.52), (2.4, 0.09, 0.055), mats["amber"], bevel=0.004)
    cube("AwardsMuseum_PorticoBeam", group, (0, 4.95, -4.06), (11.4, 0.44, 0.62), mats["paper"], bevel=0.03)
    cube("AwardsMuseum_PorticoGoldLine", group, (0, 5.24, -4.42), (10.2, 0.11, 0.08), mats["gold"], bevel=0.004)

    for index, x in enumerate([-4.9, -3.35, 3.35, 4.9]):
        cube(f"AwardsMuseum_RoadColumn_{index}", group, (x, 2.2, -4.0), (0.52, 3.95, 0.52), mats["paper"], bevel=0.032)
        cube(f"AwardsMuseum_RoadColumnBase_{index}", group, (x, 0.38, -4.0), (0.92, 0.28, 0.86), mats["stone_shadow"], bevel=0.02)
        cube(f"AwardsMuseum_RoadColumnCapital_{index}", group, (x, 4.16, -4.0), (0.98, 0.28, 0.86), mats["stone_shadow"], bevel=0.02)

    for index, z in enumerate([-5.25, -4.78, -4.31]):
        cube(f"AwardsMuseum_RoadStep_{index}", group, (0, 0.18 + index * 0.052, z), (8.6 - index * 0.72, 0.13, 0.38), mats["stone"], bevel=0.022)
    for index, x in enumerate([-3.6, -1.8, 0, 1.8, 3.6]):
        cube(f"AwardsMuseum_ArrivalMedalTile_{index}", group, (x, 0.43, -6.06), (0.82, 0.06, 0.72), [mats["paper"], mats["gold"], mats["amber"], mats["gold"], mats["paper"]][index], bevel=0.006)

    cube("AwardsMuseum_EntablatureBand", group, (0, 4.92, -0.02), (13.4, 0.42, 7.15), mats["wood"], bevel=0.04)
    cube("AwardsMuseum_UpperStoneCrown", group, (0, 5.38, -0.02), (12.15, 0.46, 6.05), mats["stone"], bevel=0.04)
    cube("AwardsMuseum_RoofDeck", group, (0, 5.85, -0.02), (10.6, 0.34, 5.2), mats["dark"], bevel=0.035)
    cube("AwardsMuseum_RoofLanternBase", group, (0, 6.48, -0.35), (4.8, 1.2, 2.55), mats["stone_shadow"], bevel=0.04)
    cube("AwardsMuseum_RoofLanternGlassFront", group, (0, 6.48, -1.72), (3.75, 0.75, 0.08), mats["glass"], bevel=0.008)
    cube("AwardsMuseum_RoofLanternGlassRear", group, (0, 6.48, 1.02), (3.75, 0.75, 0.08), mats["glass"], bevel=0.008)
    cube("AwardsMuseum_RoofLanternCap", group, (0, 7.24, -0.35), (5.35, 0.34, 3.05), mats["gold"], bevel=0.032)
    cube("AwardsMuseum_RoofMedalPlinth", group, (0, 7.64, -0.35), (1.45, 0.34, 1.05), mats["stone_shadow"], bevel=0.024)
    cylinder("AwardsMuseum_RoofMedalDisk", group, (0, 8.02, -0.35), 0.72, 0.12, mats["gold"], vertices=28, bevel=0.012)

    for side, x, face_sign in [("Left", -7.28, -1), ("Right", 7.28, 1)]:
        cube(f"AwardsMuseum_{side}SideWall", group, (x, 2.68, 0.18), (0.46, 4.75, 6.1), mats["stone_shadow"], bevel=0.04)
        cube(f"AwardsMuseum_{side}SideCornice", group, (x, 4.96, 0.18), (0.6, 0.22, 6.45), mats["paper"], bevel=0.016)
        cube(f"AwardsMuseum_{side}SideBaseTrim", group, (x, 0.84, 0.18), (0.58, 0.16, 6.3), mats["wood"], bevel=0.006)
        for row, y in enumerate([1.58, 2.38, 3.18]):
            cube(f"AwardsMuseum_{side}GalleryBand_{row}", group, (x + face_sign * 0.035, y + 0.32, 0.18), (0.07, 0.06, 5.25), mats["gold"], bevel=0.002)
        for index, z in enumerate([-2.25, -1.05, 0.15, 1.35, 2.55]):
            material = [mats["paper"], mats["glass"], mats["gold"], mats["glass"], mats["paper"]][index]
            cube(f"AwardsMuseum_{side}CertificateCase_{index}", group, (x + face_sign * 0.06, 2.42, z), (0.08, 1.22, 0.72), material, bevel=0.006)
            cube(f"AwardsMuseum_{side}CaseLight_{index}", group, (x + face_sign * 0.075, 3.18, z), (0.06, 0.055, 0.55), mats["amber"], bevel=0.002)

    cube("AwardsMuseum_RearArchiveDoorFrame", group, (0, 1.82, 3.92), (4.25, 2.86, 0.24), mats["dark"], bevel=0.02)
    cube("AwardsMuseum_RearArchiveDoor", group, (0, 1.42, 4.08), (2.25, 2.04, 0.08), mats["stone"], bevel=0.012)
    cube("AwardsMuseum_RearArchiveHeader", group, (0, 3.42, 4.1), (7.7, 0.22, 0.08), mats["gold"], bevel=0.004)
    cube("AwardsMuseum_RearServiceWalk", group, (0, 0.32, 4.82), (7.2, 0.12, 0.95), mats["paper"], bevel=0.026)
    for index, x in enumerate([-4.8, -3.2, -1.6, 1.6, 3.2, 4.8]):
        cube(f"AwardsMuseum_RearRecordWindow_{index}", group, (x, 2.38, 3.98), (0.86, 1.1, 0.08), [mats["glass"], mats["paper"], mats["gold"], mats["gold"], mats["paper"], mats["glass"]][index], bevel=0.006)
        cube(f"AwardsMuseum_RearRecordLamp_{index}", group, (x, 3.15, 4.06), (0.58, 0.06, 0.05), mats["amber"], bevel=0.002)

    cube("AwardsMuseum_FrontMedalBackplate", group, (0, 3.02, -4.54), (2.45, 2.05, 0.12), mats["stone_shadow"], bevel=0.018)
    cylinder("AwardsMuseum_FrontMedalSeal", group, (0, 3.26, -4.63), 0.78, 0.1, mats["gold"], vertices=28, bevel=0.012)
    cube("AwardsMuseum_FrontRibbonLeft", group, (-0.28, 2.34, -4.72), (0.22, 0.98, 0.08), mats["amber"], rot=(0, 0, -0.14), bevel=0.004)
    cube("AwardsMuseum_FrontRibbonRight", group, (0.28, 2.34, -4.72), (0.22, 0.98, 0.08), mats["paper"], rot=(0, 0, 0.14), bevel=0.004)

    for index, x in enumerate([-4.35, -2.95, 2.95, 4.35]):
        cube(f"AwardsMuseum_FrontCertificateCase_{index}", group, (x, 2.42, -4.46), (0.78, 1.18, 0.08), [mats["paper"], mats["gold"], mats["gold"], mats["paper"]][index], bevel=0.006)
        cube(f"AwardsMuseum_FrontCertificateGlow_{index}", group, (x, 3.18, -4.54), (0.58, 0.06, 0.05), mats["amber"], bevel=0.002)
...
def create_circuit_time_trial_gate(mats):
    ...
    cube("CircuitControl_SiteApron", group, (0, 0.08, 0.82), (17.2, 0.16, 11.8), mats["stone_shadow"], bevel=0.05)
    cube("CircuitControl_DriveThroughLane", group, (0, 0.19, 0.92), (8.75, 0.1, 9.4), mats["rubber"], bevel=0.025)
    cube("CircuitControl_PitServiceDeck", group, (-5.9, 0.23, -0.42), (4.25, 0.18, 7.8), mats["stone"], bevel=0.035)
    cube("CircuitControl_SpectatorDeck", group, (5.9, 0.23, -0.45), (4.25, 0.18, 7.8), mats["wood"], bevel=0.035)
    for x in [-4.62, 4.62]:
        cube("CircuitControl_LaneBarrier", group, (x, 0.42, 0.68), (0.24, 0.32, 8.8), mats["paper"], bevel=0.012)
        cube("CircuitControl_LaneGlow", group, (x, 0.62, 0.68), (0.07, 0.08, 7.9), mats["amber" if x < 0 else "mint"], bevel=0.004)

    for index, z in enumerate([-2.95, -0.95, 1.05]):
        cube(f"CircuitControl_CenterLaneMark_{index}", group, (0, 0.31, z), (0.18, 0.045, 0.84), mats["paper"], bevel=0.003)
    cube("CircuitControl_StartStripe", group, (0, 0.32, 3.45), (8.25, 0.05, 0.24), mats["paper"], bevel=0.004)
    cube("CircuitControl_FinishAmberStripe", group, (0, 0.34, 3.08), (8.25, 0.05, 0.12), mats["amber"], bevel=0.004)
    for index, x in enumerate([-3.45, -2.3, -1.15, 0, 1.15, 2.3, 3.45]):
        cube(f"CircuitControl_CheckerTile_{index}", group, (x, 0.36, 3.76), (0.58, 0.05, 0.34), mats["paper" if index % 2 else "rubber"], bevel=0.003)

    cube("CircuitControl_RaceControlBlock", group, (-5.85, 1.78, -0.65), (3.95, 3.18, 5.25), mats["stone"], bevel=0.055)
    cube("CircuitControl_RaceControlRearWall", group, (-5.85, 1.86, -3.42), (3.75, 2.92, 0.22), mats["stone_shadow"], bevel=0.026)
    cube("CircuitControl_RaceControlSideWall", group, (-7.92, 1.76, -0.65), (0.22, 2.9, 5.05), mats["stone_shadow"], bevel=0.02)
    cube("CircuitControl_RoadFacingGlass", group, (-3.82, 1.92, 0.65), (0.1, 1.46, 2.42), mats["glass"], bevel=0.01)
    cube("CircuitControl_ControlRoomWindow", group, (-5.85, 2.02, 2.07), (2.58, 1.28, 0.1), mats["glass"], bevel=0.01)
    cube("CircuitControl_RaceControlRoof", group, (-5.85, 3.48, -0.65), (4.52, 0.36, 5.92), mats["wood"], bevel=0.03)
    cube("CircuitControl_TimingTower", group, (-5.85, 5.08, -0.95), (1.62, 3.28, 1.52), mats["dark"], bevel=0.032)
    cube("CircuitControl_TimingTowerGlass", group, (-5.85, 5.12, -0.12), (1.08, 1.76, 0.08), mats["screen"], bevel=0.008)
    cube("CircuitControl_TimingTowerCap", group, (-5.85, 6.85, -0.95), (2.22, 0.34, 2.0), mats["amber"], bevel=0.02)
    cylinder("CircuitControl_LapClockDisk", group, (-5.85, 5.18, -0.02), 0.54, 0.06, mats["amber"], vertices=20, bevel=0.006)
    cube("CircuitControl_LapClockHandVertical", group, (-5.85, 5.18, -0.06), (0.055, 0.72, 0.04), mats["dark"], bevel=0.002)
    cube("CircuitControl_LapClockHandHorizontal", group, (-5.85, 5.18, -0.07), (0.62, 0.055, 0.04), mats["dark"], bevel=0.002)

    cube("CircuitControl_PitWallMass", group, (5.85, 1.18, -0.56), (3.62, 2.12, 5.05), mats["wood"], bevel=0.045)
    cube("CircuitControl_PitWallScreen", group, (5.85, 1.86, 2.02), (2.42, 1.0, 0.08), mats["screen"], bevel=0.008)
    cube("CircuitControl_PitWallRearPanel", group, (5.85, 1.62, -3.13), (2.75, 1.62, 0.12), mats["stone_shadow"], bevel=0.014)
    for index, y in enumerate([1.35, 1.76, 2.17]):
        cube(f"CircuitControl_PitWallStatus_{index}", group, (5.85, y, 2.12), (1.58 - index * 0.18, 0.07, 0.045), [mats["mint"], mats["amber"], mats["paper"]][index], bevel=0.003)
    for index, z in enumerate([-2.52, -1.52, -0.52, 0.48]):
        cube(f"CircuitControl_PitWallRhythm_{index}", group, (4.02, 1.04, z), (0.09, 1.08, 0.52), mats["paper"], bevel=0.004)

    for x in [-4.72, 4.72]:
        cube("CircuitControl_StartPortalFoot", group, (x, 0.38, 3.28), (1.05, 0.56, 1.05), mats["stone"], bevel=0.04)
        cube("CircuitControl_StartPortalPost", group, (x, 2.56, 3.28), (0.46, 4.05, 0.42), mats["dark"], bevel=0.024)
        cube("CircuitControl_StartPortalGlow", group, (x, 2.56, 2.92), (0.1, 3.1, 0.055), mats["mint" if x > 0 else "amber"], bevel=0.004)
    cube("CircuitControl_StartPortalHeader", group, (0, 4.58, 3.28), (10.85, 0.56, 0.66), mats["dark"], bevel=0.034)
    cube("CircuitControl_TimingScreen", group, (0, 4.26, 2.9), (4.86, 0.76, 0.08), mats["screen"], bevel=0.008)
    for index, x in enumerate([-4.05, -3.24, -2.43, 2.43, 3.24, 4.05]):
        cube(f"CircuitControl_HeaderChecker_{index}", group, (x, 4.18, 2.82), (0.5, 0.38, 0.06), mats["paper" if index % 2 else "rubber"], bevel=0.003)
    for index, x in enumerate([-1.1, 0, 1.1]):
        cube(f"CircuitControl_StartLamp_{index}", group, (x, 3.68, 2.82), (0.48, 0.3, 0.06), [mats["pink"], mats["amber"], mats["mint"]][index], bevel=0.01)

    cube("CircuitControl_ReturnPortalHeader", group, (0, 2.86, -3.82), (8.75, 0.34, 0.48), mats["dark"], bevel=0.026)
    for x in [-4.25, 4.25]:
        cube("CircuitControl_ReturnPortalPost", group, (x, 1.52, -3.82), (0.28, 2.48, 0.32), mats["dark"], bevel=0.018)
    cube("CircuitControl_ReturnTimingStrip", group, (0, 2.62, -4.08), (5.8, 0.1, 0.08), mats["mint"], bevel=0.004)
    cube("CircuitControl_CheckpointCrown", group, (0, 5.02, 3.0), (5.65, 0.12, 0.1), mats["amber"], bevel=0.005)
    for index, x in enumerate([-2.05, -0.7, 0.7, 2.05]):
        cube(f"CircuitControl_SplitTimerBlade_{index}", group, (x, 4.88, 3.0), (0.32, 0.92, 0.08), [mats["paper"], mats["mint"], mats["amber"], mats["paper"]][index], bevel=0.004)
    cube("CircuitControl_RecoverRailLeft", group, (-7.1, 0.74, -1.8), (0.16, 1.0, 4.1), mats["dark"], bevel=0.008)
    cube("CircuitControl_RecoverRailRight", group, (7.1, 0.74, -1.8), (0.16, 1.0, 4.1), mats["dark"], bevel=0.008)
...
def create_potato_farm_stand(mats):
    ...
    cube("PotatoFarmstead_BlockyFarmCourt", group, (0, 0.08, 0), (18.4, 0.16, 10.6), mats["stone"], bevel=0.045)
    cube("PotatoFarmstead_GrassInset", group, (0, 0.17, 0.06), (17.1, 0.05, 9.36), mats["crop"], bevel=0.025)
    cube("PotatoFarmstead_RoadApron", group, (-4.0, 0.22, -5.35), (7.2, 0.11, 1.35), mats["paper"], bevel=0.022)
    cube("PotatoFarmstead_RoadStep", group, (-4.0, 0.3, -6.02), (5.8, 0.1, 0.36), mats["stone"], bevel=0.018)

    cube("PotatoFarmstead_TilledField", group, (3.05, 0.25, 0.72), (10.8, 0.16, 7.45), mats["rope"], bevel=0.02)
    for index, x in enumerate([-1.55, 0.28, 2.11, 3.94, 5.77, 7.6]):
        cube(f"PotatoFarmstead_TilledSoilRow_{index}", group, (x, 0.36, 0.72), (1.0, 0.12, 6.85), mats["wood"], bevel=0.012)
        for z in [-2.0, -0.8, 0.4, 1.6, 2.8]:
            cube(f"PotatoFarmstead_CropLeaf_{index}_{z}", group, (x - 0.12, 0.58, z), (0.54, 0.24, 0.42), mats["crop"], bevel=0.01)
            cube(f"PotatoFarmstead_BlockPotato_{index}_{z}", group, (x + 0.22, 0.48, z + 0.18), (0.28, 0.18, 0.26), mats["amber"], bevel=0.018)

    cube("PotatoFarmstead_WaterChannel", group, (8.95, 0.38, 0.72), (0.38, 0.09, 6.85), mats["aqua"], bevel=0.012)
    cube("PotatoFarmstead_IrrigationTank", group, (8.95, 0.95, -3.42), (1.35, 1.15, 1.05), mats["aqua"], bevel=0.06)
    cube("PotatoFarmstead_IrrigationPump", group, (8.95, 0.48, -2.48), (1.66, 0.52, 0.72), mats["stone_shadow"], bevel=0.028)
    cube("PotatoFarmstead_IrrigationBoom", group, (3.55, 1.26, -2.78), (9.6, 0.13, 0.13), mats["rope"], bevel=0.01)
    for x in [-0.8, 1.4, 3.6, 5.8, 8.0]:
        cube("PotatoFarmstead_IrrigationDropper", group, (x, 0.84, -2.78), (0.08, 0.78, 0.08), mats["glass"], bevel=0.004)

    cube("PotatoFarmstead_RoadStandBody", group, (-4.72, 1.22, -3.22), (5.75, 2.24, 2.0), mats["wood"], bevel=0.036)
    cube("PotatoFarmstead_RoadStandBackWall", group, (-4.72, 1.35, -2.1), (5.86, 2.42, 0.22), mats["stone_shadow"], bevel=0.02)
    cube("PotatoFarmstead_RoadStandCounter", group, (-4.72, 0.86, -4.36), (5.95, 0.7, 0.86), mats["wood"], bevel=0.03)
    cube("PotatoFarmstead_RoadStandCanopy", group, (-4.72, 2.55, -3.76), (6.55, 0.28, 2.55), mats["stone_shadow"], bevel=0.028)
    cube("PotatoFarmstead_RoadStandWarmLine", group, (-4.72, 2.28, -4.58), (4.45, 0.08, 0.06), mats["amber"], bevel=0.004)
    for index, x in enumerate([-6.4, -5.1, -3.8]):
        cube(f"PotatoFarmstead_ProduceBin_{index}", group, (x, 1.17, -4.78), (0.82, 0.42, 0.5), [mats["amber"], mats["crop"], mats["paper"]][index], bevel=0.02)
    cube("PotatoFarmstead_RoadProduceShelf", group, (-3.05, 1.24, -4.78), (2.1, 0.18, 0.5), mats["wood"], bevel=0.012)

    cube("PotatoFarmstead_FarmhouseBody", group, (-5.85, 1.46, 1.42), (4.2, 2.72, 3.2), mats["stone_shadow"], bevel=0.036)
    cube("PotatoFarmstead_FarmhouseFrontDoor", group, (-5.85, 0.9, -0.25), (1.0, 1.42, 0.1), mats["dark"], bevel=0.008)
    cube("PotatoFarmstead_FarmhouseRoof", group, (-5.85, 3.0, 1.42), (4.85, 0.36, 3.75), mats["wood"], bevel=0.028)
    cube("PotatoFarmstead_FarmhouseChimney", group, (-7.15, 3.72, 1.0), (0.52, 1.2, 0.52), mats["wood"], bevel=0.018)
    for index, z in enumerate([0.55, 1.72, 2.88]):
        cube(f"PotatoFarmstead_FarmhouseSideWindow_{index}", group, (-8.06, 1.62, z), (0.08, 0.44, 0.5), mats["glass"], bevel=0.004)

    cube("PotatoFarmstead_LowSeedHouseBody", group, (0.28, 1.0, 3.88), (3.7, 1.75, 1.65), mats["glass"], bevel=0.028)
    cube("PotatoFarmstead_LowSeedHouseRoof", group, (0.28, 2.02, 3.88), (4.1, 0.22, 1.95), mats["wood"], bevel=0.018)
    for x in [-1.2, 0.28, 1.76]:
        cube("PotatoFarmstead_LowSeedHouseRib", group, (x, 1.24, 3.02), (0.1, 1.55, 0.08), mats["foam"], bevel=0.004)

    cube("PotatoFarmstead_CrateZoneBase", group, (6.8, 0.3, 4.18), (4.2, 0.12, 1.35), mats["wood"], bevel=0.014)
    for index, x in enumerate([5.55, 6.65, 7.75]):
        cube(f"PotatoFarmstead_StorageCrate_{index}", group, (x, 0.72, 4.18), (0.86, 0.72, 0.78), [mats["wood"], mats["amber"], mats["wood"]][index], bevel=0.022)
        cube(f"PotatoFarmstead_CratePotato_{index}", group, (x, 1.18, 3.9), (0.44, 0.22, 0.34), mats["amber"], bevel=0.018)

    for index, x in enumerate([-8.3, -5.6, -2.9, -0.2, 2.5, 5.2, 7.9]):
        cube(f"PotatoFarmstead_BackFencePost_{index}", group, (x, 0.64, 5.18), (0.14, 0.98, 0.14), mats["dark"], bevel=0.01)
    cube("PotatoFarmstead_BackFenceRail", group, (-0.2, 0.88, 5.18), (16.8, 0.12, 0.12), mats["wood"], bevel=0.01)
    for index, z in enumerate([-3.2, -1.2, 0.8, 2.8, 4.8]):
        cube(f"PotatoFarmstead_RightFencePost_{index}", group, (9.38, 0.64, z), (0.14, 0.98, 0.14), mats["dark"], bevel=0.01)
    cube("PotatoFarmstead_RightFenceRail", group, (9.38, 0.88, 0.8), (0.12, 0.12, 8.0), mats["wood"], bevel=0.01)

    cube("PotatoFarmstead_ScarecrowPost", group, (1.2, 1.15, -3.42), (0.14, 1.9, 0.14), mats["wood"], bevel=0.01)
    cube("PotatoFarmstead_ScarecrowArm", group, (1.2, 1.84, -3.42), (1.4, 0.11, 0.11), mats["wood"], bevel=0.006)
    cube("PotatoFarmstead_ScarecrowHead", group, (1.2, 2.34, -3.42), (0.42, 0.42, 0.42), mats["amber"], bevel=0.03)
    cube("PotatoFarmstead_ScarecrowHat", group, (1.2, 2.64, -3.42), (0.68, 0.12, 0.5), mats["dark"], bevel=0.008)

    cube("PotatoFarmstead_BlockPotatoMarker", group, (-7.95, 1.68, -4.55), (0.86, 0.62, 0.36), mats["amber"], rot=(0.05, 0, -0.1), bevel=0.05)
    cube("PotatoFarmstead_BlockPotatoEyeA", group, (-8.2, 1.72, -4.76), (0.08, 0.06, 0.04), mats["dark"], bevel=0.003)
...
def create_sentinel_soc_tower(mats):
    ...
    cube("SentinelSoc_SitePlinth", group, (0, 0.08, 0), (15.4, 0.16, 9.8), mats["stone"], bevel=0.055)
    cube("SentinelSoc_RoadScanApron", group, (0, 0.22, -5.42), (10.7, 0.18, 2.05), mats["paper"], bevel=0.045)
    cube("SentinelSoc_SiteBackEdge", group, (0, 0.31, 4.8), (14.5, 0.2, 0.22), mats["dark"], bevel=0.014)
    for x in [-6.9, 6.9]:
        cube(f"SentinelSoc_SiteSideCurb_{x}", group, (x, 0.31, -0.32), (0.22, 0.2, 8.6), mats["dark"], bevel=0.012)

    cube("SentinelSoc_OperationsHall", group, (-0.35, 2.58, -0.08), (11.4, 4.88, 6.5), mats["stone_shadow"], bevel=0.085)
    cube("SentinelSoc_SolidCommandWing", group, (4.75, 2.82, -0.05), (3.25, 5.35, 5.95), mats["stone_shadow"], bevel=0.06)
    cube("SentinelSoc_IncidentResponseHall", group, (1.55, 1.86, 3.05), (8.2, 3.1, 2.25), mats["stone_shadow"], bevel=0.05)
    cube("SentinelSoc_CommandCampusRoof", group, (-0.35, 5.12, -0.08), (12.2, 0.45, 7.05), mats["dark"], bevel=0.04)
    cube("SentinelSoc_IncidentRoof", group, (1.55, 3.5, 3.05), (8.8, 0.34, 2.72), mats["dark"], bevel=0.028)

    cube("SentinelSoc_RoutePublicSocGatewayHall", group, (0, 2.5, -3.62), (10.8, 3.95, 1.52), mats["dark"], bevel=0.038)
    cube("SentinelSoc_RoutePublicSocGatewayFrame", group, (0, 2.85, -4.38), (11.25, 4.65, 0.34), mats["dark"], bevel=0.03)
    cube("SentinelSoc_RouteShieldControlEntry", group, (0, 2.7, -4.6), (7.7, 2.8, 0.08), mats["glass"], bevel=0.01)
    cube("SentinelSoc_RouteShieldControlHeader", group, (0, 4.26, -4.68), (8.4, 0.16, 0.08), mats["mint"], bevel=0.004)
    cube("SentinelSoc_ShieldGateFrame", group, (0, 2.82, -4.78), (8.55, 4.08, 0.22), mats["dark"], bevel=0.024)
    cube("SentinelSoc_ShieldGateGlass", group, (0, 2.56, -4.92), (6.55, 2.66, 0.08), mats["glass"], bevel=0.008)
    cube("SentinelSoc_ScanThreshold", group, (0, 0.36, -5.85), (7.4, 0.08, 0.58), mats["pink"], bevel=0.004)
    for x in [-4.95, 4.95]:
        cube(f"SentinelSoc_RouteShieldThresholdPier_{x}", group, (x, 2.95, -4.72), (0.62, 5.35, 0.58), mats["stone_shadow"], bevel=0.026)
        cube(f"SentinelSoc_ScanPortalBase_{x}", group, (x, 0.86, -5.08), (0.58, 1.5, 0.62), mats["dark"], bevel=0.018)
    cube("SentinelSoc_RouteShieldThresholdBeam", group, (0, 5.78, -4.72), (10.55, 0.5, 0.58), mats["dark"], bevel=0.022)
    cube("SentinelSoc_ScanPortalBeam", group, (0, 4.72, -5.08), (10.35, 0.28, 0.34), mats["dark"], bevel=0.018)
    cube("SentinelSoc_ScanPortalBeamGlow", group, (0, 4.92, -5.28), (8.2, 0.08, 0.06), mats["pink"], bevel=0.004)
    cube("SentinelSoc_RouteShieldCrestTop", group, (0, 3.48, -5.02), (1.85, 0.16, 0.06), mats["mint"], bevel=0.004)
    cube("SentinelSoc_RouteShieldCrestLeft", group, (-0.65, 2.78, -5.05), (0.16, 1.32, 0.06), mats["mint"], rot=(0, 0, -0.25), bevel=0.004)
    cube("SentinelSoc_RouteShieldCrestRight", group, (0.65, 2.78, -5.05), (0.16, 1.32, 0.06), mats["mint"], rot=(0, 0, 0.25), bevel=0.004)
    cube("SentinelSoc_RouteShieldCore", group, (0, 2.62, -5.08), (0.7, 0.58, 0.05), mats["screen"], bevel=0.003)

    cube("SentinelSoc_RouteEntryPorticoDeck", group, (0, 0.68, -4.55), (9.1, 0.24, 1.18), mats["stone_shadow"], bevel=0.018)
    cube("SentinelSoc_RouteEntryPorticoRoof", group, (0, 4.92, -4.42), (10.55, 0.38, 1.02), mats["dark"], bevel=0.018)
    cube("SentinelSoc_RouteEntryWarRoomGlass", group, (0, 2.72, -4.94), (6.25, 2.25, 0.08), mats["glass"], bevel=0.008)
    cube("SentinelSoc_RouteWarRoomVolume", group, (-0.55, 3.08, -2.72), (5.8, 2.75, 0.86), mats["glass"], bevel=0.014)
    cube("SentinelSoc_RouteWarRoomFloor", group, (-0.55, 1.74, -2.72), (5.92, 0.22, 0.95), mats["stone_shadow"], bevel=0.012)
    cube("SentinelSoc_RouteWarRoomCommandDesk", group, (-0.55, 2.02, -3.18), (3.35, 0.42, 0.26), mats["dark"], bevel=0.01)
    cube("SentinelSoc_RouteDefenseCanopy", group, (0, 5.1, -3.52), (9.3, 0.24, 1.22), mats["screen"], bevel=0.01)
    cube("SentinelSoc_RouteDefenseCanopyGlow", group, (0, 5.25, -4.15), (7.8, 0.06, 0.06), mats["mint"], bevel=0.003)
    cube("SentinelSoc_RouteOpsPortalLeftPylon", group, (-3.96, 2.85, -5.02), (0.34, 4.7, 0.4), mats["dark"], bevel=0.018)
    cube("SentinelSoc_RouteOpsPortalRightPylon", group, (3.96, 2.85, -5.02), (0.34, 4.7, 0.4), mats["dark"], bevel=0.018)
    cube("SentinelSoc_RouteOpsPortalOverhead", group, (0, 5.08, -5.02), (8.2, 0.34, 0.42), mats["dark"], bevel=0.018)
    cube("SentinelSoc_RouteOpsPortalThreshold", group, (0, 0.55, -5.02), (7.1, 0.18, 0.36), mats["paper"], bevel=0.01)
    for index, x in enumerate([-3.05, -1.52, 0, 1.52, 3.05]):
        cube(f"SentinelSoc_RouteInspectionLaneMark_{index}", group, (x, 0.38, -5.35), (0.76, 0.05, 0.1), mats["mint"] if index % 2 == 0 else mats["screen"], bevel=0.002)
    for index, x in enumerate([-2.5, -1.25, 0, 1.25, 2.5]):
        cube(f"SentinelSoc_RoutePacketQueueRail_{index}", group, (x, 0.82, -3.88), (0.08, 0.12, 0.55), mats["mint"] if index % 2 == 0 else mats["screen"], bevel=0.003)
    for index, x in enumerate([-3.1, -1.55, 0, 1.55, 3.1]):
        cube(f"SentinelSoc_RouteStatusLane_{index}", group, (x, 4.75, -3.02), (0.68, 0.07, 0.06), mats["screen"], bevel=0.003)

    cube("SentinelSoc_OverwatchTowerPrimary", group, (-4.92, 6.35, 0.34), (3.1, 12.25, 3.15), mats["stone_shadow"], bevel=0.052)
    cube("SentinelSoc_TowerBase", group, (-4.92, 2.25, 0.34), (3.65, 3.8, 3.45), mats["stone_shadow"], bevel=0.052)
    cube("SentinelSoc_OverwatchTowerGlassFront", group, (-4.92, 6.1, -1.32), (1.95, 7.1, 0.08), mats["glass"], bevel=0.006)
    cube("SentinelSoc_OverwatchTowerRearGlass", group, (-4.92, 5.92, 2.0), (1.68, 5.25, 0.08), mats["glass"], bevel=0.006)
    cube("SentinelSoc_OverwatchTowerSideGlass", group, (-6.52, 5.8, 0.42), (0.08, 6.1, 1.72), mats["glass"], bevel=0.006)
    cube("SentinelSoc_TowerCrown", group, (-4.92, 12.62, 0.34), (3.95, 0.52, 3.55), mats["dark"], bevel=0.028)
    cube("SentinelSoc_OverwatchCrown", group, (-4.92, 10.35, 0.34), (3.35, 0.34, 3.15), mats["dark"], bevel=0.024)
    cube("SentinelSoc_OverwatchSpire", group, (-4.92, 15.15, 0.34), (0.26, 4.5, 0.26), mats["dark"], bevel=0.008)
    cube("SentinelSoc_ThreatIntelArray", group, (-4.92, 14.0, 0.34), (3.85, 0.16, 0.16), mats["pink"], bevel=0.006)
    cube("SentinelSoc_ThreatIntelUpperArray", group, (-4.92, 15.3, 0.34), (2.6, 0.12, 0.12), mats["screen"], bevel=0.004)
    cube("SentinelSoc_RouteThreatIntelCrownMast", group, (-4.92, 13.72, 0.34), (0.24, 3.4, 0.24), mats["dark"], bevel=0.008)
    cube("SentinelSoc_RouteThreatIntelCrownBar", group, (-4.92, 15.08, 0.34), (3.6, 0.16, 0.16), mats["pink"], bevel=0.006)
    cube("SentinelSoc_RouteThreatIntelCrownUpperBar", group, (-4.92, 16.0, 0.34), (2.45, 0.12, 0.12), mats["screen"], bevel=0.004)

    cube("SentinelSoc_CommandTower", group, (4.55, 5.15, 0.88), (2.65, 7.35, 2.9), mats["stone_shadow"], bevel=0.04)
    cube("SentinelSoc_CommandTowerGlass", group, (4.55, 5.58, -0.67), (1.8, 3.45, 0.08), mats["glass"], bevel=0.006)
    cube("SentinelSoc_CommandCrownBar", group, (4.55, 9.02, 0.88), (3.05, 0.34, 3.05), mats["screen"], bevel=0.01)
    cube("SentinelSoc_RouteCommandBeaconMast", group, (4.55, 10.65, 0.88), (0.22, 3.1, 0.22), mats["dark"], bevel=0.008)
    cube("SentinelSoc_RouteCommandBeaconHead", group, (4.55, 12.35, 0.88), (0.66, 0.42, 0.66), mats["mint"], bevel=0.016)
    cube("SentinelSoc_RouteCommandFacade", group, (5.95, 2.8, -1.78), (0.2, 3.0, 3.05), mats["dark"], bevel=0.018)
    cube("SentinelSoc_RouteCommandGlass", group, (6.08, 2.86, -1.78), (0.08, 1.82, 2.25), mats["glass"], bevel=0.006)
    cube("SentinelSoc_CommandWindowBand", group, (6.1, 2.25, 1.5), (0.08, 2.0, 2.72), mats["glass"], bevel=0.006)
    cube("SentinelSoc_RouteCommandWindowMassLeft", group, (6.16, 2.62, -2.55), (0.08, 1.72, 0.78), mats["screen"], bevel=0.004)
    cube("SentinelSoc_RouteCommandWindowMassRight", group, (6.16, 2.62, 1.42), (0.08, 1.72, 0.78), mats["screen"], bevel=0.004)

    cube("SentinelSoc_RearOperationsEnvelope", group, (0.0, 2.44, 4.62), (11.4, 3.85, 0.55), mats["stone_shadow"], bevel=0.038)
    cube("SentinelSoc_RearEnvelopeCrown", group, (0.0, 4.58, 4.72), (11.8, 0.36, 0.72), mats["dark"], bevel=0.022)
    cube("SentinelSoc_RearServiceEntry", group, (-4.0, 1.43, 5.02), (1.2, 2.05, 0.14), mats["dark"], bevel=0.014)
    cube("SentinelSoc_RearIncidentEntry", group, (4.0, 1.43, 5.02), (1.2, 2.05, 0.14), mats["dark"], bevel=0.014)
    cube("SentinelSoc_RearCommandBand", group, (0, 3.08, 5.08), (6.9, 1.0, 0.08), mats["glass"], bevel=0.006)
    cube("SentinelSoc_ThreatWallBase", group, (0.0, 2.5, 5.18), (5.9, 2.2, 0.18), mats["dark"], bevel=0.018)
    cube("SentinelSoc_ThreatWallMap", group, (0.0, 2.58, 5.3), (4.72, 1.22, 0.08), mats["pink"], bevel=0.004)
    cube("SentinelSoc_ThreatWallStatusRail", group, (0.0, 3.3, 5.35), (5.35, 0.08, 0.06), mats["screen"], bevel=0.003)
    for index, x in enumerate([-3.0, -1.0, 1.0, 3.0]):
        cube(f"SentinelSoc_ServerRack_{index}", group, (x, 1.34, 5.28), (0.82, 1.55, 0.1), mats["stone_shadow"], bevel=0.012)
        cube(f"SentinelSoc_RackGlow_{index}", group, (x, 1.68, 5.38), (0.5, 0.07, 0.06), mats["screen"], bevel=0.002)
    for index, x in enumerate([-2.55, -1.25, 0.05, 1.35]):
        cube(f"SentinelSoc_PacketShardPanel_{index}", group, (x, 2.0 + (index % 2) * 0.32, 5.42), (0.58, 0.08, 0.06), mats["mint"] if index % 2 == 0 else mats["pink"], bevel=0.003)

    cube("SentinelSoc_LeftFinishedEnvelope", group, (-6.1, 2.28, -0.02), (0.46, 4.2, 6.15), mats["stone_shadow"], bevel=0.034)
    cube("SentinelSoc_RightFinishedEnvelope", group, (6.1, 2.24, -0.02), (0.46, 4.08, 6.15), mats["stone_shadow"], bevel=0.034)
    cube("SentinelSoc_SideEnvelopeCrownLeft", group, (-6.1, 4.5, -0.02), (0.6, 0.34, 6.48), mats["dark"], bevel=0.02)
    cube("SentinelSoc_SideEnvelopeCrownRight", group, (6.1, 4.42, -0.02), (0.6, 0.34, 6.48), mats["dark"], bevel=0.02)
    for index, z in enumerate([-2.35, -0.78, 0.78, 2.35]):
        cube(f"SentinelSoc_LeftThreatReviewWindow_{index}", group, (-6.37, 2.62, z), (0.08, 1.55, 0.78), mats["glass"], bevel=0.006)
        cube(f"SentinelSoc_RightCommandWindow_{index}", group, (6.37, 2.58, z), (0.08, 1.48, 0.78), mats["glass"], bevel=0.006)
    ...
    for index, z in enumerate([-1.75, -0.55, 0.65]):
        cube(f"SentinelSoc_RouteIncidentReviewBay_{index}", group, (5.98, 1.36, z), (0.08, 0.38, 0.68), mats["aqua"], bevel=0.003)

    cube("SentinelSoc_BlueTeamBridge", group, (0.0, 5.38, 2.65), (8.8, 0.2, 0.32), mats["screen"], bevel=0.008)
    cube("SentinelSoc_ScannerBridge", group, (0.0, 5.42, -2.86), (8.4, 0.24, 0.34), mats["pink"], bevel=0.008)
    cube("SentinelSoc_ScannerBridgeLower", group, (0.0, 5.02, -2.86), (7.2, 0.1, 0.22), mats["screen"], bevel=0.006)
    cube("SentinelSoc_CommandCatwalk", group, (0.0, 5.8, 2.52), (8.95, 0.14, 0.24), mats["mint"], bevel=0.006)
    cube("SentinelSoc_OverwatchDeck", group, (-0.2, 5.76, 0.82), (8.9, 0.38, 4.45), mats["rubber"], bevel=0.024)
    cube("SentinelSoc_OverwatchRailFront", group, (-0.2, 6.08, -1.62), (8.65, 0.12, 0.1), mats["screen"], bevel=0.004)
    cube("SentinelSoc_OverwatchRailBack", group, (-0.2, 6.08, 2.92), (8.65, 0.12, 0.1), mats["mint"], bevel=0.004)
...
def create_signal_harbor_communications_station(mats):
    ...
    cube("ContactExchange_SitePlinth", group, (0, 0.09, 0.25), (17.4, 0.18, 10.8), mats["stone"], bevel=0.055)
    cube("ContactExchange_RoadForecourt", group, (0, 0.22, 6.58), (12.6, 0.18, 3.15), mats["paper"], bevel=0.04)
    cube("ContactExchange_ForecourtCenterSpine", group, (0, 0.36, 6.58), (0.24, 0.08, 2.55), mats["stone_shadow"], bevel=0.006)
    for x in [-5.95, 5.95]:
        cube("ContactExchange_ForecourtCurb", group, (x, 0.42, 6.58), (0.24, 0.28, 2.85), mats["stone_shadow"], bevel=0.012)

    cube("ContactExchange_MainHall", group, (0, 2.28, 0.0), (12.8, 4.35, 6.7), mats["stone_shadow"], bevel=0.07)
    cube("ContactExchange_LeftMailWing", group, (-5.15, 2.34, 0.12), (3.1, 4.15, 6.1), mats["wood"], bevel=0.055)
    cube("ContactExchange_RightRelayWing", group, (5.05, 2.34, 0.12), (3.1, 4.15, 6.1), mats["stone"], bevel=0.055)
    cube("ContactExchange_RoofSlab", group, (0, 4.62, 0.0), (13.6, 0.45, 7.4), mats["dark"], bevel=0.034)
    cube("ContactExchange_Clerestory", group, (0, 5.72, -0.6), (8.6, 1.65, 2.55), mats["glass"], bevel=0.038)
    cube("ContactExchange_ClerestoryRoof", group, (0, 6.67, -0.6), (9.45, 0.34, 3.05), mats["dark"], bevel=0.028)

    cube("ContactExchange_RoadGatewayFrame", group, (0, 2.68, 3.58), (10.9, 3.5, 0.32), mats["dark"], bevel=0.032)
    cube("ContactExchange_RoadGatewayGlass", group, (0, 2.62, 3.78), (9.58, 2.38, 0.08), mats["glass"], bevel=0.01)
    cube("ContactExchange_GatewayHeaderGlow", group, (0, 4.18, 3.86), (9.95, 0.22, 0.08), mats["mint"], bevel=0.004)
    cube("ContactExchange_GatewayBaseGlow", group, (0, 1.08, 3.86), (8.95, 0.16, 0.08), mats["screen"], bevel=0.004)
    cube("ContactExchange_EnvelopeRidge", group, (0, 3.23, 3.96), (6.2, 0.13, 0.08), mats["paper"], bevel=0.004)
    cube("ContactExchange_EnvelopeFlapLeft", group, (-1.55, 2.72, 4.02), (3.45, 0.1, 0.08), mats["paper"], rot=(0.0, 0.0, -0.32), bevel=0.003)
    cube("ContactExchange_EnvelopeFlapRight", group, (1.55, 2.72, 4.02), (3.45, 0.1, 0.08), mats["paper"], rot=(0.0, 0.0, 0.32), bevel=0.003)

    for index, x in enumerate([-3.55, 0, 3.55]):
        material = [mats["screen"], mats["mint"], mats["aqua"]][index]
        cube(f"ContactExchange_ChannelPortal_{index}", group, (x, 1.92, 4.14), (2.2, 1.58, 0.18), mats["dark"], bevel=0.018)
        cube(f"ContactExchange_ChannelGlass_{index}", group, (x, 1.96, 4.27), (1.52, 0.98, 0.075), material, bevel=0.006)
        cube(f"ContactExchange_ChannelSill_{index}", group, (x, 1.24, 4.29), (1.7, 0.12, 0.06), mats["paper"], bevel=0.003)
        cube(f"ContactExchange_ChannelBeacon_{index}", group, (x, 2.78, 4.31), (1.56, 0.11, 0.055), [mats["paper"], mats["amber"], mats["paper"]][index], bevel=0.003)

    for x in [-4.05, -2.05, 2.05, 4.05]:
        cube("ContactExchange_OfficeWindow", group, (x, 3.48, 3.87), (1.08, 0.56, 0.07), mats["glass"], bevel=0.006)
        cube("ContactExchange_OfficeWindowSill", group, (x, 3.1, 3.92), (1.24, 0.08, 0.06), mats["paper"], bevel=0.003)

    for side, x in [("Left", -6.47), ("Right", 6.47)]:
        cube(f"ContactExchange_{side}SolidWall", group, (x, 2.42, 0.05), (0.2, 3.65, 5.55), mats["stone_shadow"], bevel=0.018)
        cube(f"ContactExchange_{side}RibbonWindow", group, (x + (-0.09 if x < 0 else 0.09), 2.82, 0.05), (0.08, 1.16, 3.9), mats["glass"], bevel=0.006)
        cube(f"ContactExchange_{side}MessageColumn", group, (x + (-0.13 if x < 0 else 0.13), 2.62, 2.18), (0.08, 2.35, 0.58), mats["dark"], bevel=0.006)
        for index, z in enumerate([-1.65, -0.55, 0.55, 1.65]):
            cube(f"ContactExchange_{side}ReceiverSlot_{index}", group, (x + (-0.14 if x < 0 else 0.14), 3.5, z), (0.06, 0.08, 0.72), [mats["mint"], mats["screen"], mats["aqua"], mats["mint"]][index], bevel=0.003)
        for index, y in enumerate([1.22, 1.72, 2.22]):
            cube(f"ContactExchange_{side}ChannelStatus_{index}", group, (x + (-0.15 if x < 0 else 0.15), y, -2.1), (0.07, 0.28, 0.66), [mats["screen"], mats["paper"], mats["mint"]][index], bevel=0.004)

    cube("ContactExchange_RearWall", group, (0, 2.36, -3.48), (11.7, 3.65, 0.24), mats["stone_shadow"], bevel=0.024)
    cube("ContactExchange_RearServiceDoor", group, (-5.0, 1.35, -3.64), (0.96, 2.0, 0.1), mats["dark"], bevel=0.014)
    cube("ContactExchange_RearExchangeFrame", group, (0.82, 2.44, -3.68), (7.25, 2.02, 0.12), mats["dark"], bevel=0.018)
    cube("ContactExchange_RearExchangeGlass", group, (0.82, 2.46, -3.78), (6.28, 1.4, 0.07), mats["glass"], bevel=0.006)
    for index, x in enumerate([-1.35, 0.82, 2.98]):
        cube(f"ContactExchange_RearChannelBay_{index}", group, (x, 2.46, -3.86), (1.28, 0.9, 0.06), [mats["screen"], mats["mint"], mats["aqua"]][index], bevel=0.004)
        cube(f"ContactExchange_RearChannelHeader_{index}", group, (x, 3.22, -3.88), (1.06, 0.08, 0.055), mats["paper"], bevel=0.003)
    for index, x in enumerate([-3.92, 4.62]):
        cube(f"ContactExchange_RearCableTrunk_{index}", group, (x, 2.58, -3.82), (0.16, 2.45, 0.08), mats["wood"], bevel=0.006)
    cube("ContactExchange_RearSignalRail", group, (0, 4.38, -3.63), (8.4, 0.14, 0.08), mats["screen"], bevel=0.004)

    cube("ContactExchange_RoofReceiverMast", group, (4.72, 7.05, -1.65), (0.34, 4.1, 0.34), mats["dark"], bevel=0.014)
    cube("ContactExchange_RoofReceiverCrossbar", group, (4.72, 8.28, -1.65), (3.45, 0.12, 0.12), mats["dark"], bevel=0.006)
    cone("ContactExchange_RoofDish", group, (3.05, 7.22, -1.98), 1.08, 0.36, mats["foam"], vertices=22, rot=(math.pi / 2, 0.0, 0.44))
    cube("ContactExchange_RoofDishCore", group, (2.7, 7.22, -2.22), (0.24, 0.24, 0.18), mats["screen"], bevel=0.016)
    cube("ContactExchange_RoofBeacon", group, (4.72, 9.05, -1.65), (0.72, 0.44, 0.72), mats["amber"], bevel=0.038)
    cube("ContactExchange_PublicSignalBridge", group, (0, 5.08, 2.95), (8.1, 0.18, 0.18), mats["screen"], bevel=0.006)
    for index, x in enumerate([-3.2, -1.6, 0, 1.6, 3.2]):
        cube(f"ContactExchange_RoofPacketLight_{index}", group, (x, 4.98, 2.82), (0.82, 0.08, 0.08), [mats["screen"], mats["mint"], mats["aqua"], mats["mint"], mats["screen"]][index], bevel=0.003)
