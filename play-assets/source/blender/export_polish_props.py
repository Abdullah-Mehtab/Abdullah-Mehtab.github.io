...
def create_projects_foundry_building(mats):
    ...
    cube("ProjectsFoundry_FabricationBay", group, (5.38, 1.52, 0.3), (4.0, 2.72, 4.72), mats["wood"], bevel=0.04)
    cube("ProjectsFoundry_FabricationStack", group, (5.74, 3.24, 0.5), (1.5, 2.08, 2.4), mats["stone_shadow"], bevel=0.018)
    cube("ProjectsFoundry_SideWorkshop", group, (-6.08, 1.28, 0.8), (2.55, 2.28, 3.85), mats["stone"], bevel=0.04)
    cube("ProjectsFoundry_MaterialArchiveWing", group, (-6.28, 2.54, 0.8), (1.32, 2.0, 2.7), mats["stone"], bevel=0.018)
    ...
    cube("ProjectsFoundry_PublicBuildTheater", group, (-1.05, 2.12, 4.0), (8.45, 2.24, 0.14), mats["wood"], bevel=0.014)
    cube("ProjectsFoundry_PublicBuildGlass", group, (-1.05, 2.06, 4.1), (6.86, 1.52, 0.06), mats["glass"], bevel=0.008)
    cube("ProjectsFoundry_PublicBuildHeader", group, (-1.05, 3.36, 4.16), (8.9, 0.18, 0.12), mats["screen"], bevel=0.006)
    cube("ProjectsFoundry_PublicBuildFooter", group, (-1.05, 0.82, 4.16), (7.1, 0.16, 0.1), mats["amber"], bevel=0.006)
    cube("ProjectsFoundry_RouteAssemblyHallLeftPier", group, (-5.9, 2.12, 4.38), (0.3, 2.68, 0.12), mats["stone_shadow"], bevel=0.018)
    cube("ProjectsFoundry_RouteAssemblyHallRightPier", group, (3.8, 2.12, 4.38), (0.3, 2.68, 0.12), mats["stone_shadow"], bevel=0.018)
    cube("ProjectsFoundry_RouteAssemblyHallSill", group, (-1.05, 0.82, 4.38), (9.88, 0.18, 0.12), mats["stone_shadow"], bevel=0.014)
    cube("ProjectsFoundry_RouteAssemblyHallGlass", group, (-1.05, 2.18, 4.48), (7.95, 1.82, 0.06), mats["glass"], bevel=0.008)
    for index, x in enumerate([-4.0, -2.4, -0.8, 0.8, 2.4]):
        cube(f"ProjectsFoundry_RouteAssemblyHallMullion_{index}", group, (x, 2.18, 4.56), (0.09, 1.88, 0.06), mats["paper"], bevel=0.003)
    cube("ProjectsFoundry_RouteAssemblyHallHeader", group, (-1.05, 3.48, 4.56), (10.0, 0.2, 0.12), mats["wood"], bevel=0.01)
    cube("ProjectsFoundry_RouteAssemblyHallForgeCore", group, (-1.05, 1.1, 4.58), (6.25, 0.22, 0.08), mats["amber"], bevel=0.006)
    cube("ProjectsFoundry_RouteAssemblyHallCompileGlow", group, (-1.05, 2.86, 4.6), (5.8, 0.07, 0.06), mats["mint"], bevel=0.003)
    cube("ProjectsFoundry_RouteCranePortalLeft", group, (-6.15, 2.08, 4.52), (0.16, 3.0, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteCranePortalRight", group, (4.05, 2.08, 4.52), (0.16, 3.0, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteCranePortalBeam", group, (-1.05, 3.68, 4.52), (10.25, 0.16, 0.16), mats["stone_shadow"])
    ...
    cube("ProjectsFoundry_CompilePipelineBridge", group, (1.15, 4.28, 4.12), (6.1, 0.14, 0.22), mats["amber"], bevel=0.008)
    cube("ProjectsFoundry_CompilePipelineGlow", group, (1.15, 4.12, 4.28), (5.2, 0.06, 0.06), mats["mint"], bevel=0.003)
    ...
    cube("ProjectsFoundry_RouteBuildCraneBeam", group, (3.4, 3.42, 4.02), (2.45, 0.1, 0.14), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildCranePost", group, (4.48, 2.0, 4.02), (0.12, 2.28, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalDeck", group, (-1.05, 0.56, 4.88), (9.8, 0.14, 0.26), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalLeftPier", group, (-5.68, 2.32, 4.92), (0.2, 2.85, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalRightPier", group, (3.58, 2.32, 4.92), (0.2, 2.85, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalHeader", group, (-1.05, 3.76, 4.92), (9.48, 0.18, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalGlass", group, (-1.05, 2.24, 5.0), (7.0, 1.74, 0.06), mats["glass"])
    cube("ProjectsFoundry_RouteReleasePipelineSpine", group, (-0.62, 3.08, 5.08), (6.4, 0.11, 0.06), mats["mint"])
    ...
    cube("ProjectsFoundry_RouteCompileGantryFrame", group, (-1.05, 4.42, 5.12), (9.7, 0.16, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RoutePublicShowcaseAtriumFrame", group, (-1.05, 2.4, 5.34), (9.45, 2.42, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RoutePublicShowcaseAtriumGlass", group, (-1.05, 2.34, 5.44), (7.72, 1.62, 0.06), mats["glass"], bevel=0.006)
    cube("ProjectsFoundry_RoutePublicShowcaseAtriumHeader", group, (-1.05, 3.78, 5.5), (9.75, 0.22, 0.14), mats["wood"], bevel=0.01)
    ...
    cube("ProjectsFoundry_RouteBuildReviewBalcony", group, (2.6, 3.32, 5.54), (3.2, 0.16, 0.2), mats["paper"], bevel=0.008)
    cube("ProjectsFoundry_RouteBuildReviewCanopy", group, (2.6, 3.64, 5.48), (3.6, 0.14, 0.22), mats["dark"], bevel=0.008)
    cube("ProjectsFoundry_RouteReleaseGantryLeftFrame", group, (-5.86, 2.36, 5.76), (0.2, 3.22, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseGantryRightFrame", group, (3.76, 2.36, 5.76), (0.2, 3.22, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseGantryHeader", group, (-1.05, 4.08, 5.74), (9.8, 0.2, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseGantryStatusGlow", group, (-1.05, 4.48, 5.94), (7.4, 0.07, 0.06), mats["mint"], bevel=0.003)
    ...
    cube("ProjectsFoundry_RouteRepositoryAtriumFaceFrame", group, (-1.05, 2.7, 6.18), (9.7, 3.0, 0.12), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteRepositoryAtriumFaceGlass", group, (-1.05, 2.62, 6.28), (7.9, 1.92, 0.06), mats["glass"], bevel=0.006)
    cube("ProjectsFoundry_RouteRepositoryAtriumFaceHeader", group, (-1.05, 4.32, 6.34), (10.0, 0.24, 0.12), mats["wood"], bevel=0.012)
    cube("ProjectsFoundry_RouteRepositoryAtriumFaceSill", group, (-1.05, 1.02, 6.34), (8.8, 0.2, 0.12), mats["stone_shadow"], bevel=0.01)
    ...
    cube("ProjectsFoundry_RouteReleaseCraneCrownLeft", group, (-5.86, 4.96, 6.18), (0.2, 1.08, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseCraneCrownRight", group, (3.76, 4.96, 6.18), (0.2, 1.08, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseCraneCrownBeam", group, (-1.05, 5.54, 6.18), (9.95, 0.2, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseCraneCrownGlow", group, (-1.05, 5.8, 6.38), (7.8, 0.07, 0.06), mats["amber"], bevel=0.003)
    ...
    cube("ProjectsFoundry_RouteSideRepositoryFaceFrame", group, (7.06, 3.24, 1.08), (0.14, 3.45, 2.78), mats["stone_shadow"])
    ...
    cube("ProjectsFoundry_RouteFabricationStackPublicFace", group, (5.82, 3.88, -1.22), (1.84, 2.36, 0.08), mats["stone_shadow"])
