...
def create_projects_foundry_building(mats):
    ...
    cube("ProjectsFoundry_FabricationStack", group, (5.82, 3.62, 0.52), (2.08, 2.9, 3.12), mats["stone_shadow"], bevel=0.02)
    cube("ProjectsFoundry_SideWorkshop", group, (-6.28, 1.38, 0.82), (3.15, 2.58, 4.4), mats["stone"], bevel=0.045)
    cube("ProjectsFoundry_MaterialArchiveWing", group, (-6.46, 2.92, 0.82), (1.86, 2.72, 3.22), mats["stone"], bevel=0.02)
    ...
    cube("ProjectsFoundry_PublicBuildTheater", group, (-1.05, 2.36, 4.0), (10.4, 3.05, 0.18), mats["stone_shadow"], bevel=0.018)
    ...
    cube("ProjectsFoundry_RouteAssemblyHallLeftPier", group, (-6.58, 2.44, 4.38), (0.44, 3.54, 0.14), mats["stone_shadow"], bevel=0.028)
    cube("ProjectsFoundry_RouteAssemblyHallRightPier", group, (4.48, 2.44, 4.38), (0.44, 3.54, 0.14), mats["stone_shadow"], bevel=0.028)
    cube("ProjectsFoundry_RouteAssemblyHallSill", group, (-1.05, 0.72, 4.38), (11.72, 0.28, 0.14), mats["stone_shadow"], bevel=0.022)
    cube("ProjectsFoundry_RouteAssemblyHallGlass", group, (-1.05, 2.4, 4.5), (9.55, 2.32, 0.08), mats["glass"], bevel=0.01)
    for index, x in enumerate([-4.78, -3.05, -1.32, 0.41, 2.14]):
        cube(f"ProjectsFoundry_RouteAssemblyHallMullion_{index}", group, (x, 2.42, 4.58), (0.12, 2.5, 0.08), mats["paper"], bevel=0.004)
    cube("ProjectsFoundry_RouteAssemblyHallHeader", group, (-1.05, 4.02, 4.58), (11.95, 0.26, 0.16), mats["wood"], bevel=0.014)
    cube("ProjectsFoundry_RouteAssemblyHallForgeCore", group, (-1.05, 1.02, 4.6), (8.15, 0.34, 0.11), mats["amber"], bevel=0.01)
    cube("ProjectsFoundry_RouteAssemblyHallCompileGlow", group, (-1.05, 3.24, 4.62), (7.8, 0.1, 0.08), mats["mint"], bevel=0.004)
    cube("ProjectsFoundry_RouteCranePortalLeft", group, (-6.92, 2.18, 4.52), (0.26, 3.75, 0.24), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteCranePortalRight", group, (4.82, 2.18, 4.52), (0.26, 3.75, 0.24), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteCranePortalBeam", group, (-1.05, 4.12, 4.52), (12.08, 0.24, 0.24), mats["stone_shadow"])
    ...
    cube("ProjectsFoundry_RouteBuildCraneBeam", group, (3.88, 3.78, 4.02), (3.3, 0.14, 0.18), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildCranePost", group, (5.38, 2.1, 4.02), (0.16, 2.85, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalDeck", group, (-1.05, 0.46, 4.88), (12.4, 0.18, 0.34), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalLeftPier", group, (-6.42, 2.56, 4.92), (0.3, 3.45, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalRightPier", group, (4.32, 2.56, 4.92), (0.3, 3.45, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteBuildTheaterPortalHeader", group, (-1.05, 4.3, 4.92), (11.1, 0.24, 0.16), mats["stone_shadow"])
    ...
    cube("ProjectsFoundry_RouteCompileGantryFrame", group, (-1.05, 5.1, 5.12), (12.0, 0.22, 0.16), mats["stone_shadow"])
    cube("ProjectsFoundry_RoutePublicShowcaseAtriumFrame", group, (-1.05, 2.68, 5.34), (12.65, 3.48, 0.16), mats["stone_shadow"])
    ...
    cube("ProjectsFoundry_RouteReleaseGantryLeftFrame", group, (-6.65, 2.54, 5.76), (0.28, 4.0, 0.22), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseGantryRightFrame", group, (4.55, 2.54, 5.76), (0.28, 4.0, 0.22), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseGantryHeader", group, (-1.05, 4.76, 5.74), (11.55, 0.26, 0.22), mats["stone_shadow"])
    ...
    cube("ProjectsFoundry_RouteRepositoryAtriumFaceFrame", group, (-1.05, 3.1, 6.18), (13.35, 4.15, 0.18), mats["stone_shadow"])
    ...
    for index, x in enumerate([-4.8, -3.0, -1.2, 0.6, 2.4]):
    ...
    for index, (x, y) in enumerate([(-4.35, 2.02), (-1.2, 2.66), (2.2, 3.08)]):
    ...
    cube("ProjectsFoundry_RouteReleaseCraneCrownLeft", group, (-6.82, 5.52, 6.18), (0.3, 1.45, 0.22), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseCraneCrownRight", group, (4.72, 5.52, 6.18), (0.3, 1.45, 0.22), mats["stone_shadow"])
    cube("ProjectsFoundry_RouteReleaseCraneCrownBeam", group, (-1.05, 6.28, 6.18), (12.15, 0.26, 0.22), mats["stone_shadow"])
