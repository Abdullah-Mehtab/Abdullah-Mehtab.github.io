...
def create_behind_engineering_garage(mats):
    ...
    cube("BehindEngineeringGarage_PrototypeTower", group, (5.92, 3.6, 0.52), (2.28, 3.72, 3.44), mats["dark"], bevel=0.035)
...
def create_sentinel_soc_tower(mats):
    ...
    cube("SentinelSoc_UpperOperationsDeck", group, (-2.0, 3.8, 0.68), (8.0, 1.48, 4.35), mats["dark"], bevel=0.038)
    cube("SentinelSoc_GlassOpsRoom", group, (3.65, 1.56, -0.25), (3.1, 2.56, 4.25), mats["glass"], bevel=0.038)
    cube("SentinelSoc_GlassCommandStack", group, (3.7, 3.62, -0.25), (2.34, 3.08, 3.35), mats["glass"], bevel=0.03)
    ...
    cube("SentinelSoc_ShieldGateFrame", group, (1.3, 2.18, -4.7), (6.2, 3.25, 0.18), mats["dark"], bevel=0.026)
    cube("SentinelSoc_ShieldGateGlass", group, (1.3, 2.04, -4.82), (4.55, 2.18, 0.07), mats["glass"], bevel=0.008)
