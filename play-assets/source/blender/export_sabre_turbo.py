...
def add_glass_and_frames(parent, mats):
    ...
    add_polyline("Trim_WindshieldChromeLip", windshield_frame, mats["dark_chrome"], parent, thickness=0.014)
    ...
    for side, label in [(-1, "Left"), (1, "Right")]:
        ...
        add_polyline(f"Trim_WindowFrame_{label}", side_window, mats["dark_chrome"], parent, thickness=0.026)
