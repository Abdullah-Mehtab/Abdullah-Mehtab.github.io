...
export const meadowDetailPatches = [
  ...
  { id: 'contact-career-crosswind-lawn', center: [112, 20], size: [34, 9], rotation: -0.38, color: '#78b7ff' },
  { id: 'project-harbor-signal-lawn', center: [116, 42], size: [24, 7], rotation: -0.18, color: '#ffcc66' },
  { id: 'contact-inner-grass-cut', center: [132, 20], size: [20, 6], rotation: 0.44, color: '#84d7bd' },
...
export const fieldMotifClusters = [
  ...
  { id: 'east-signal-crossfield', center: [112, 18], size: [48, 28], rotation: -0.28, palette: ['#78b7ff', '#ffcc66', '#84d7bd'], berms: 4, ribbons: 8, seed: 127 },
  ...
  { id: 'contact-approach-meadow', center: [130, 28], size: [30, 22], rotation: -0.46, palette: ['#78b7ff', '#f3d19c', '#84d7bd'], berms: 3, ribbons: 6, seed: 137 },
