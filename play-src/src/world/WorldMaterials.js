...
export const QUALITY_PROFILES = {
  ...
  high: {
    ...
    districtDressingRadius: 148,
    broadSetPieceRadius: 168,
    stuntDressingRadius: 184,
    farmDressingRadius: 176,
    routeCompositionRadius: 108,
    meadowCompositionRadius: 68,
    windCadence: 2,
    particleCadence: 1,
    shadows: true,
    water: 'high',
...
export function createWorldMaterials() {
  ...
  return {
    ...
    terrainBrushLight: makeTerrainBrushMaterial(0xb2df7a, 0.28, terrainBrushAlpha),
    terrainBrushDark: makeTerrainBrushMaterial(0x2f6b3b, 0.24, terrainBrushAlpha),
    terrainBrushWarm: makeTerrainBrushMaterial(0xd0b072, 0.22, terrainBrushAlpha),
...
export function makeIslandGeometry(radius, segments = 144, scale = 1) {
  ...
  const colors = [];
  const deepGrass = new THREE.Color(0x2f703f);
  const meadow = new THREE.Color(0x76b962);
  const warmGrass = new THREE.Color(0xb2c766);
  const coast = new THREE.Color(0xd9b075);
