...
export const QUALITY_PROFILES = {
  low: {
    ...
    districtDressingRadius: 64,
    broadSetPieceRadius: 118,
    stuntDressingRadius: 76,
    farmDressingRadius: 76,
  ...
  medium: {
    ...
    broadSetPieceRadius: 134,
    stuntDressingRadius: 142,
    farmDressingRadius: 142,
    routeCompositionRadius: 78,
    meadowCompositionRadius: 40,
    windCadence: 3,
    particleCadence: 2,
    shadows: false,
    water: 'medium',
  ...
  high: {
    ...
    props: 48,
    fireflies: 56,
    lifeSignals: { zonePulses: 16, windBanners: 10, whisperBeacons: 10, terminalPulses: 6, districtMotes: 64, districtSignals: 16 },
    districtDressingRadius: 184,
    broadSetPieceRadius: 208,
    stuntDressingRadius: 220,
    farmDressingRadius: 220,
    routeCompositionRadius: 132,
    meadowCompositionRadius: 90,
    windCadence: 2,
    particleCadence: 1,
    shadows: true,
    water: 'high',
...
export function createWorldMaterials() {
  ...
  return {
    ...
    meadowLight: new THREE.MeshStandardMaterial({ color: 0x7fbe63, roughness: 0.98, metalness: 0.0 }),
    meadowDark: new THREE.MeshStandardMaterial({ color: 0x3f7f45, roughness: 0.98, metalness: 0.0 }),
    ...
    stoneRoad: new THREE.MeshStandardMaterial({ color: 0x555d56, map: stoneTexture, roughness: 0.92, metalness: 0.02 }),
    plazaRoad: new THREE.MeshStandardMaterial({ color: 0xb9ad8e, map: stoneTexture, roughness: 0.9, metalness: 0.02 }),
    ...
    roadShoulder: new THREE.MeshStandardMaterial({ color: 0x747b62, roughness: 0.96, metalness: 0.0 }),
    roadCurb: new THREE.MeshStandardMaterial({ color: 0xd1c39a, roughness: 0.86, metalness: 0.02 }),
