...
export class SetPieces {
  constructor(world) {
    ...
    this.gate4b5Stats = {
      ...
      awards: {
        ...
        routeHonorsEntryHalls: 0,
        routeSolidHonorsFacades: 0,
        routeMedalWindowBackplates: 0,
        signs: 0,
        lamps: 0
      },
      sentinel: {
  ...
  createGate4B5AwardsArchive(group) {
    ...
    if (this.addPolishAsset(group, 'EnvPolishAwardsMuseumHall', museum[0], museum[1], rotation, presentation.scale)) {
      ...
      stats.routeHonorsEntryHalls += 1;
      stats.routeSolidHonorsFacades += 1;
      stats.routeMedalWindowBackplates += 1;
    }
