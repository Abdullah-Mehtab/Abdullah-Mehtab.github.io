...
const GATE4_FR_B_GATE_ID = 'gate-4fr-b-start-flow-launch-removal';
const GATE4_FR_C_GATE_ID = 'gate-4fr-c-landmark-rebuilds';
...
const GOAL_GATE = GATE4_FR_E_GATE_ID;
...
const GATE4_E_BS_GATE_ID = 'gate-4e-bs-bruno-route-approach-benchmark-evidence';
const GATE4_E_BT_GATE_ID = 'gate-4e-bt-route-place-integration-pass';
const GATE4_E_BU_GATE_ID = 'gate-4e-bu-contact-route-exchange-benchmark-pass';
const GATE4_E_BV_GATE_ID = 'gate-4e-bv-cv-route-side-archive-readability-pass';
const GATE4_E_BW_GATE_ID = 'gate-4e-bw-todo-route-sprint-board-benchmark-pass';
const GATE4_E_BX_GATE_ID = 'gate-4e-bx-awards-route-honors-forecourt-benchmark-pass';
const GATE4_E_BY_GATE_ID = 'gate-4e-by-security-scanner-threshold-benchmark-pass';
const GATE4_E_BZ_GATE_ID = 'gate-4e-bz-route-framing-benchmark-sweep';
const GATE4_E_CA_GATE_ID = 'gate-4e-ca-projects-route-foundry-facade-benchmark-pass';
const GATE4_E_CB_GATE_ID = 'gate-4e-cb-skills-route-learning-systems-facade-benchmark-pass';
const GATE4_E_CC_GATE_ID = 'gate-4e-cc-circuit-route-time-trial-gantry-benchmark-pass';
const GATE4_E_CD_GATE_ID = 'gate-4e-cd-potato-route-harvest-silhouette-benchmark-pass';
const GATE4_E_CE_GATE_ID = 'gate-4e-ce-launch-hub-forecourt-first-frame-benchmark-pass';
const GATE4_E_CF_GATE_ID = 'gate-4e-cf-todo-planning-hall-facade-benchmark-pass';
const GATE4_E_CG_GATE_ID = 'gate-4e-cg-contact-exchange-forecourt-benchmark-pass';
const GATE4_E_CH_GATE_ID = 'gate-4e-ch-skills-side-learning-campus-benchmark-pass';
const GATE4_E_CI_GATE_ID = 'gate-4e-ci-security-operations-threshold-benchmark-pass';
const GATE4_E_CJ_GATE_ID = 'gate-4e-cj-circuit-drive-through-checkpoint-benchmark-pass';
const GATE4_E_CK_GATE_ID = 'gate-4e-ck-awards-route-honors-arrival-benchmark-pass';
const GATE4_E_CL_GATE_ID = 'gate-4e-cl-launch-hub-world-entry-first-frame-benchmark-pass';
const GATE4_E_CM_GATE_ID = 'gate-4e-cm-projects-public-build-forecourt-benchmark-pass';
const GATE4_E_CN_GATE_ID = 'gate-4e-cn-contact-public-signal-arrival-benchmark-pass';
const GATE4_E_CO_GATE_ID = 'gate-4e-co-projects-hierarchy-simplification-benchmark-pass';
const GATE4_E_CP_GATE_ID = 'gate-4e-cp-projects-build-hall-silhouette-benchmark-pass';
const GATE4_E_CQ_GATE_ID = 'gate-4e-cq-projects-single-hall-facade-benchmark-pass';
const GATE4_E_CR_GATE_ID = 'gate-4e-cr-projects-material-silhouette-benchmark-pass';
const GATE4_E_CS_GATE_ID = 'gate-4e-cs-awards-solid-entry-benchmark-pass';
const GATE4_E_CT_GATE_ID = 'gate-4e-ct-sentinel-public-soc-threshold-benchmark-pass';
const GATE4_E_CU_GATE_ID = 'gate-4e-cu-road-path-hygiene-blocker';
const GATE4_F_D_GATE_ID = 'gate-4f-d-site-integration-pass';
const GATE4_F_E_GATE_ID = 'gate-4f-e-self-acceptance-lock';
const GATE4_D_GATE_IDS = [GATE4_D_B1_GATE_ID, GATE4_D_B2_GATE_ID, GATE4_D_B3_GATE_ID, GATE4_D_B4_GATE_ID, GATE4_D_B5_GATE_ID, GATE4_D_B6_GATE_ID, GATE4_D_D_GATE_ID, GATE4_E_C_GATE_ID, GATE4_E_D_GATE_ID, GATE4_E_F_GATE_ID, GATE4_E_G_GATE_ID, GATE4_E_H_GATE_ID, GATE4_E_I_GATE_ID, GATE4_E_J_GATE_ID, GATE4_E_K_GATE_ID, GATE4_E_L_GATE_ID, GATE4_E_M_GATE_ID, GATE4_E_N_GATE_ID, GATE4_E_O_GATE_ID, GATE4_E_P_GATE_ID, GATE4_E_Q_GATE_ID, GATE4_E_R_GATE_ID, GATE4_E_S_GATE_ID, GATE4_E_T_GATE_ID, GATE4_E_U_GATE_ID, GATE4_E_V_GATE_ID, GATE4_E_W_GATE_ID, GATE4_E_X_GATE_ID, GATE4_E_Y_GATE_ID, GATE4_E_Z_GATE_ID, GATE4_E_AA_GATE_ID, GATE4_E_AB_GATE_ID, GATE4_E_AC_GATE_ID, GATE4_E_AD_GATE_ID, GATE4_E_AE_GATE_ID, GATE4_E_AF_GATE_ID, GATE4_E_AG_GATE_ID, GATE4_E_AH_GATE_ID, GATE4_E_AI_GATE_ID, GATE4_E_AJ_GATE_ID, GATE4_E_AK_GATE_ID, GATE4_E_AL_GATE_ID, GATE4_E_AM_GATE_ID, GATE4_E_AN_GATE_ID, GATE4_E_AO_GATE_ID, GATE4_E_AP_GATE_ID, GATE4_E_AQ_GATE_ID, GATE4_E_AR_GATE_ID, GATE4_E_AS_GATE_ID, GATE4_E_AT_GATE_ID, GATE4_E_AU_GATE_ID, GATE4_E_AV_GATE_ID, GATE4_E_AW_GATE_ID, GATE4_E_AX_GATE_ID, GATE4_E_AY_GATE_ID, GATE4_E_AZ_GATE_ID, GATE4_E_BA_GATE_ID, GATE4_E_BB_GATE_ID, GATE4_E_BC_GATE_ID, GATE4_E_BD_GATE_ID, GATE4_E_BE_GATE_ID, GATE4_E_BF_GATE_ID, GATE4_E_BG_GATE_ID, GATE4_E_BH_GATE_ID, GATE4_E_BI_GATE_ID, GATE4_E_BJ_GATE_ID, GATE4_E_BK_GATE_ID, GATE4_E_BL_GATE_ID, GATE4_E_BM_GATE_ID, GATE4_E_BN_GATE_ID, GATE4_E_BO_GATE_ID, GATE4_E_BP_GATE_ID, GATE4_E_BQ_GATE_ID, GATE4_E_BR_GATE_ID, GATE4_E_BS_GATE_ID, GATE4_E_BT_GATE_ID, GATE4_E_BU_GATE_ID, GATE4_E_BV_GATE_ID, GATE4_E_BW_GATE_ID, GATE4_E_BX_GATE_ID, GATE4_E_BY_GATE_ID, GATE4_E_BZ_GATE_ID, GATE4_E_CA_GATE_ID, GATE4_E_CB_GATE_ID, GATE4_E_CC_GATE_ID, GATE4_E_CD_GATE_ID, GATE4_E_CE_GATE_ID, GATE4_E_CF_GATE_ID, GATE4_E_CG_GATE_ID, GATE4_E_CH_GATE_ID, GATE4_E_CI_GATE_ID, GATE4_E_CJ_GATE_ID, GATE4_E_CK_GATE_ID, GATE4_E_CL_GATE_ID, GATE4_E_CM_GATE_ID, GATE4_E_CN_GATE_ID, GATE4_E_CO_GATE_ID, GATE4_E_CP_GATE_ID, GATE4_E_CQ_GATE_ID, GATE4_E_CR_GATE_ID, GATE4_E_CS_GATE_ID, GATE4_E_CT_GATE_ID, GATE4_E_CU_GATE_ID, GATE4_F_D_GATE_ID, GATE4_F_E_GATE_ID, ...GATE4_FR_GATE_IDS];
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    this.gate4ePrimaryRouteDiscoveryMode = GOAL_GATE === GATE4_E_BF_GATE_ID || GOAL_GATE === GATE4_E_BG_GATE_ID || GOAL_GATE === GATE4_E_BH_GATE_ID || GOAL_GATE === GATE4_E_BI_GATE_ID || GOAL_GATE === GATE4_E_BJ_GATE_ID || GOAL_GATE === GATE4_E_BK_GATE_ID || GOAL_GATE === GATE4_E_BL_GATE_ID || GOAL_GATE === GATE4_E_BM_GATE_ID || GOAL_GATE === GATE4_E_BN_GATE_ID || GOAL_GATE === GATE4_E_BO_GATE_ID || GOAL_GATE === GATE4_E_BP_GATE_ID || GOAL_GATE === GATE4_E_BQ_GATE_ID || GOAL_GATE === GATE4_E_BR_GATE_ID || GOAL_GATE === GATE4_E_BS_GATE_ID || GOAL_GATE === GATE4_E_BT_GATE_ID || GOAL_GATE === GATE4_E_BU_GATE_ID || GOAL_GATE === GATE4_E_BV_GATE_ID || GOAL_GATE === GATE4_E_BW_GATE_ID || GOAL_GATE === GATE4_E_BX_GATE_ID || GOAL_GATE === GATE4_E_BY_GATE_ID || GOAL_GATE === GATE4_E_BZ_GATE_ID || GOAL_GATE === GATE4_E_CA_GATE_ID || GOAL_GATE === GATE4_E_CB_GATE_ID || GOAL_GATE === GATE4_E_CC_GATE_ID || GOAL_GATE === GATE4_E_CD_GATE_ID || GOAL_GATE === GATE4_E_CE_GATE_ID || GOAL_GATE === GATE4_E_CF_GATE_ID || GOAL_GATE === GATE4_E_CG_GATE_ID || GOAL_GATE === GATE4_E_CH_GATE_ID || GOAL_GATE === GATE4_E_CI_GATE_ID || GOAL_GATE === GATE4_E_CJ_GATE_ID || GOAL_GATE === GATE4_E_CK_GATE_ID || GOAL_GATE === GATE4_E_CL_GATE_ID || GOAL_GATE === GATE4_E_CM_GATE_ID || GOAL_GATE === GATE4_E_CN_GATE_ID || GOAL_GATE === GATE4_E_CO_GATE_ID || GOAL_GATE === GATE4_E_CP_GATE_ID || GOAL_GATE === GATE4_E_CQ_GATE_ID || GOAL_GATE === GATE4_E_CR_GATE_ID || GOAL_GATE === GATE4_E_CS_GATE_ID || GOAL_GATE === GATE4_E_CT_GATE_ID;
    this.gate4eRoadPathHygieneMode = this.gate4frMode || GOAL_GATE === GATE4_E_CU_GATE_ID || GOAL_GATE === GATE4_F_D_GATE_ID || GOAL_GATE === GATE4_F_E_GATE_ID;
    this.gate4fSelfAcceptanceMode = this.gate4frMode || GOAL_GATE === GATE4_F_E_GATE_ID;
    if (GOAL_GATE === GATE4_E_AV_GATE_ID || GOAL_GATE === GATE4_E_AW_GATE_ID || GOAL_GATE === GATE4_E_AX_GATE_ID || GOAL_GATE === GATE4_E_AY_GATE_ID || GOAL_GATE === GATE4_E_AZ_GATE_ID || GOAL_GATE === GATE4_E_BA_GATE_ID || GOAL_GATE === GATE4_E_BB_GATE_ID || GOAL_GATE === GATE4_E_BC_GATE_ID || GOAL_GATE === GATE4_E_BD_GATE_ID || GOAL_GATE === GATE4_E_BE_GATE_ID || GOAL_GATE === GATE4_E_BF_GATE_ID || GOAL_GATE === GATE4_E_BG_GATE_ID || GOAL_GATE === GATE4_E_BH_GATE_ID || GOAL_GATE === GATE4_E_BI_GATE_ID || GOAL_GATE === GATE4_E_BJ_GATE_ID || GOAL_GATE === GATE4_E_BK_GATE_ID || GOAL_GATE === GATE4_E_BL_GATE_ID || GOAL_GATE === GATE4_E_BM_GATE_ID || GOAL_GATE === GATE4_E_BN_GATE_ID || GOAL_GATE === GATE4_E_BO_GATE_ID || GOAL_GATE === GATE4_E_BP_GATE_ID || GOAL_GATE === GATE4_E_BQ_GATE_ID || GOAL_GATE === GATE4_E_BR_GATE_ID || GOAL_GATE === GATE4_E_BS_GATE_ID || GOAL_GATE === GATE4_E_BT_GATE_ID || GOAL_GATE === GATE4_E_BU_GATE_ID || GOAL_GATE === GATE4_E_BV_GATE_ID || GOAL_GATE === GATE4_E_BW_GATE_ID || GOAL_GATE === GATE4_E_BX_GATE_ID || GOAL_GATE === GATE4_E_BY_GATE_ID || GOAL_GATE === GATE4_E_BZ_GATE_ID || GOAL_GATE === GATE4_E_CA_GATE_ID || GOAL_GATE === GATE4_E_CB_GATE_ID || GOAL_GATE === GATE4_E_CC_GATE_ID || GOAL_GATE === GATE4_E_CD_GATE_ID || GOAL_GATE === GATE4_E_CE_GATE_ID || GOAL_GATE === GATE4_E_CF_GATE_ID || GOAL_GATE === GATE4_E_CG_GATE_ID || GOAL_GATE === GATE4_E_CH_GATE_ID || GOAL_GATE === GATE4_E_CI_GATE_ID || GOAL_GATE === GATE4_E_CJ_GATE_ID || GOAL_GATE === GATE4_E_CK_GATE_ID || GOAL_GATE === GATE4_E_CL_GATE_ID || GOAL_GATE === GATE4_E_CM_GATE_ID || GOAL_GATE === GATE4_E_CN_GATE_ID || GOAL_GATE === GATE4_E_CO_GATE_ID || GOAL_GATE === GATE4_E_CP_GATE_ID || GOAL_GATE === GATE4_E_CQ_GATE_ID || GOAL_GATE === GATE4_E_CR_GATE_ID || GOAL_GATE === GATE4_E_CS_GATE_ID || GOAL_GATE === GATE4_E_CT_GATE_ID || this.gate4eRoadPathHygieneMode) {
    ...
    if (this.gate4frLaunchRemovedMode) {
      this.gate4eLaunchHubMode = false;
    }
    if (this.gate4eRoadPathHygieneMode) {
      this.gate4eRouteCompositionMode = false;
      this.gate4ePrimaryRouteDiscoveryMode = false;
    }
