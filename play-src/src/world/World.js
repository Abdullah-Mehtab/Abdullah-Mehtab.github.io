...
const GOAL_GATE = 'gate-4b2-west-service';
const GATE4_B1_GATE_IDS = new Set(['gate-4b1-south-run', 'gate-4b2-west-service']);
const GATE4_B2_GATE_IDS = new Set(['gate-4b2-west-service']);
