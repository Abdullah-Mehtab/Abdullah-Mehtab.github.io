...
const GOAL_GATE = 'gate-4e-p-skills-data-center-readability-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    this.gate4dLifeMode = GOAL_GATE === GATE4_D_D_GATE_ID || GOAL_GATE === GATE4_E_C_GATE_ID || GOAL_GATE === GATE4_E_D_GATE_ID || GOAL_GATE === GATE4_E_F_GATE_ID || GOAL_GATE === GATE4_E_G_GATE_ID || GOAL_GATE === GATE4_E_H_GATE_ID || GOAL_GATE === GATE4_E_I_GATE_ID || GOAL_GATE === GATE4_E_J_GATE_ID || GOAL_GATE === GATE4_E_K_GATE_ID || GOAL_GATE === GATE4_E_L_GATE_ID || GOAL_GATE === GATE4_E_M_GATE_ID || GOAL_GATE === GATE4_E_N_GATE_ID || GOAL_GATE === GATE4_E_O_GATE_ID || GOAL_GATE === GATE4_E_P_GATE_ID;
