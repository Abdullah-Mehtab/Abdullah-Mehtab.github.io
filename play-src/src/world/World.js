...
const GOAL_GATE = 'gate-4b1-south-run';
const FOUNDATION_GATE_IDS = new Set(['gate-2r-foundation-replacement', 'gate-3r-vertical-slice', 'gate-4b1-south-run']);
const VERTICAL_SLICE_GATE_IDS = new Set(['gate-3-vertical-slice', 'gate-3r-vertical-slice', 'gate-4b1-south-run']);
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    this.gate4b1Mode = GOAL_GATE === 'gate-4b1-south-run';
