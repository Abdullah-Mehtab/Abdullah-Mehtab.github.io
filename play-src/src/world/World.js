...
const GOAL_GATE = 'gate-4f-e-self-acceptance-lock';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    this.gate4eRoadPathHygieneMode = GOAL_GATE === GATE4_E_CU_GATE_ID || GOAL_GATE === GATE4_F_D_GATE_ID || GOAL_GATE === GATE4_F_E_GATE_ID;
    this.gate4fSelfAcceptanceMode = GOAL_GATE === GATE4_F_E_GATE_ID;
