...
const GOAL_GATE = 'gate-4e-ax-skills-learning-campus-route-court-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    if (GOAL_GATE === GATE4_E_AV_GATE_ID || GOAL_GATE === GATE4_E_AW_GATE_ID || GOAL_GATE === GATE4_E_AX_GATE_ID) {
