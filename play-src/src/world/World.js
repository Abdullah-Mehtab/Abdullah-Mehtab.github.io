...
const GOAL_GATE = 'gate-4e-aw-career-campus-arrival-court-route-read-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    if (GOAL_GATE === GATE4_E_AV_GATE_ID || GOAL_GATE === GATE4_E_AW_GATE_ID) {
