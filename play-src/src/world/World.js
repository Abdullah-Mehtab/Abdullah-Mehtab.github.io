...
const GOAL_GATE = 'gate-4e-bc-signal-harbor-contact-exchange-route-gateway-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    if (GOAL_GATE === GATE4_E_AV_GATE_ID || GOAL_GATE === GATE4_E_AW_GATE_ID || GOAL_GATE === GATE4_E_AX_GATE_ID || GOAL_GATE === GATE4_E_AY_GATE_ID || GOAL_GATE === GATE4_E_AZ_GATE_ID || GOAL_GATE === GATE4_E_BA_GATE_ID || GOAL_GATE === GATE4_E_BB_GATE_ID || GOAL_GATE === GATE4_E_BC_GATE_ID) {
