...
const GOAL_GATE = 'gate-4e-ab-signal-harbor-contact-gateway-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    this.gate4eSiteGroundCraftMode = GOAL_GATE === GATE4_E_X_GATE_ID || GOAL_GATE === GATE4_E_Y_GATE_ID || GOAL_GATE === GATE4_E_Z_GATE_ID || GOAL_GATE === GATE4_E_AA_GATE_ID || GOAL_GATE === GATE4_E_AB_GATE_ID;
    this.gate4eLaunchHubMode = GOAL_GATE === GATE4_E_Y_GATE_ID || GOAL_GATE === GATE4_E_Z_GATE_ID || GOAL_GATE === GATE4_E_AA_GATE_ID || GOAL_GATE === GATE4_E_AB_GATE_ID;
