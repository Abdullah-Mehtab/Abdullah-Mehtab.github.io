...
const GOAL_GATE = 'gate-4e-av-behind-build-process-atrium-route-read-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    if (GOAL_GATE === GATE4_E_AV_GATE_ID) {
