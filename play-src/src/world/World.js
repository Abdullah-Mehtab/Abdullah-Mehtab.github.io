...
const GOAL_GATE = 'gate-4e-bb-career-campus-forecourt-route-read-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    if (GOAL_GATE === GATE4_E_AV_GATE_ID || GOAL_GATE === GATE4_E_AW_GATE_ID || GOAL_GATE === GATE4_E_AX_GATE_ID || GOAL_GATE === GATE4_E_AY_GATE_ID || GOAL_GATE === GATE4_E_AZ_GATE_ID || GOAL_GATE === GATE4_E_BA_GATE_ID || GOAL_GATE === GATE4_E_BB_GATE_ID) {
