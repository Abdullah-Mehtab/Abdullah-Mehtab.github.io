...
const GOAL_GATE = 'gate-4e-y-launch-hub-composition-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    this.gate4eSiteGroundCraftMode = GOAL_GATE === GATE4_E_X_GATE_ID || GOAL_GATE === GATE4_E_Y_GATE_ID;
    this.gate4eLaunchHubMode = GOAL_GATE === GATE4_E_Y_GATE_ID;
