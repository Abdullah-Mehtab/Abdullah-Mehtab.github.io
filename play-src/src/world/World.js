...
const GOAL_GATE = 'gate-4e-bg-sentinel-soc-route-threshold-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    this.gate4ePrimaryRouteDiscoveryMode = GOAL_GATE === GATE4_E_BF_GATE_ID || GOAL_GATE === GATE4_E_BG_GATE_ID;
