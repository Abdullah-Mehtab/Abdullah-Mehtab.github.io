...
const GOAL_GATE = 'gate-4f-d-site-integration-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    this.gate4eRoadPathHygieneMode = GOAL_GATE === GATE4_E_CU_GATE_ID || GOAL_GATE === GATE4_F_D_GATE_ID;
