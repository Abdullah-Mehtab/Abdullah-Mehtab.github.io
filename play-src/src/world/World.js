...
const GOAL_GATE = 'gate-4e-bf-primary-route-discovery-visibility-pass';
...
export class World {
  constructor({ scene, physics, resumeData, environmentAssets }) {
    ...
    this.gate4ePrimaryRouteDiscoveryMode = GOAL_GATE === GATE4_E_BF_GATE_ID;
