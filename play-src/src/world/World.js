...
const GOAL_GATE = 'gate-4b5-north-ridge';
const GATE4_B1_GATE_IDS = new Set(['gate-4b1-south-run', 'gate-4b2-west-service', 'gate-4b3-data-pier-side', 'gate-4b4-east-side', 'gate-4b5-north-ridge']);
const GATE4_B2_GATE_IDS = new Set(['gate-4b2-west-service', 'gate-4b3-data-pier-side', 'gate-4b4-east-side', 'gate-4b5-north-ridge']);
const GATE4_B3_GATE_IDS = new Set(['gate-4b3-data-pier-side', 'gate-4b4-east-side', 'gate-4b5-north-ridge']);
const GATE4_B4_GATE_IDS = new Set(['gate-4b4-east-side', 'gate-4b5-north-ridge']);
const GATE4_B5_GATE_IDS = new Set(['gate-4b5-north-ridge']);
